...
const StackControl = circuit('StackControl', {
  in: { reset: bit, current_opcode: bus(8) },
  out: { current_state: bus(8), exec_subcycle: bus(8), pc_increment: bit, ir_load: bit, operand_load: bit, addr_lo_load: bit, addr_hi_load: bit, mem_read: bit, mem_write: bit, write_a: bit, write_x: bit, write_y: bit, sp_decrement: bit, sp_increment: bit, stack_write: bit, use_stack_data: bit, is_lda_imm: bit, is_lda_zp: bit, is_lda_abs: bit, is_lda_abs_x: bit, is_sta_zp: bit, is_sta_abs: bit, is_sta_abs_x: bit, is_tax: bit, is_inx: bit, is_pha: bit, is_pla: bit },
  nodes: { state_reg: Register, subcycle_reg: Register, STATE_FETCH: Constant, STATE_DECODE: Constant, STATE_EXECUTE: Constant, is_fetch: Comparator, is_decode: Comparator, is_execute: Comparator, LDA_IMM: Constant, LDA_ZP: Constant, LDA_ABS: Constant, LDA_ABS_X: Constant, STA_ZP: Constant, STA_ABS: Constant, STA_ABS_X: Constant, TAX: Constant, INX: Constant, PHA: Constant, PLA: Constant, cmp_lda_imm: Comparator, cmp_lda_zp: Comparator, cmp_lda_abs: Comparator, cmp_lda_abs_x: Comparator, cmp_sta_zp: Comparator, cmp_sta_abs: Comparator, cmp_sta_abs_x: Comparator, cmp_tax: Comparator, cmp_inx: Comparator, cmp_pha: Comparator, cmp_pla: Comparator, is_imm: Or, is_zp: Or, is_abs_temp: Or, is_abs: Or, is_abs_final: Or, is_1cycle: Or, is_stack_op: Or, zero: Constant, one: Constant, two: Constant, three: Constant, four: Constant, inc_subcycle: Incrementer, subcycle_increment: Mux, always_on: Constant, is_sub0: Comparator, is_sub1: Comparator, is_sub2: Comparator, is_sub3: Comparator, is_sub4: Comparator, next_from_fetch: Mux, next_from_decode: Mux, exec_sub0: And, exec_sub1: And, exec_sub2: And, exec_sub3: And, exec_sub4: And, done_imm: And, done_zp: And, done_abs: And, done_1cyc: And, done_pha: And, done_pla: And, exec_done_temp1: Or, exec_done_temp2: Or, exec_done_temp3: Or, exec_done_temp4: Or, exec_done: Or, next_from_execute: Mux, next_state: Mux, needs_operand_any: Or, needs_operand: Or, pc_inc_exec_sub0: And, pc_inc_exec_sub1: And, pc_inc_temp: Or, pc_inc_signal: Or, operand_load_signal: And, addr_lo_load_signal: And, addr_hi_load_signal: And, is_load: Or, is_load_final: Or, mem_read_zp: And, mem_read_abs_temp: And, mem_read_abs_x: And, mem_read_abs: Or, mem_read_signal: Or, mem_write_zp: And, mem_write_abs_temp: And, mem_write_abs_x: And, mem_write_abs: Or, mem_write_signal: Or, sp_dec_signal: And, sp_inc_signal: And, stack_write_signal: And, use_stack_signal: And, write_a_imm: And, write_a_zp: And, write_a_abs_temp: And, write_a_abs_x: And, write_a_abs: Or, write_a_temp: Or, write_a_temp2: Or, write_a_pla: And, write_a_signal: Or, write_x_tax: And, write_x_inx: And, write_x_signal: Or },
  nodeArgs: { STATE_FETCH: { value: 0 }, STATE_DECODE: { value: 1 }, STATE_EXECUTE: { value: 2 }, LDA_IMM: { value: 169 }, LDA_ZP: { value: 165 }, LDA_ABS: { value: 173 }, LDA_ABS_X: { value: 189 }, STA_ZP: { value: 133 }, STA_ABS: { value: 141 }, STA_ABS_X: { value: 157 }, TAX: { value: 170 }, INX: { value: 232 }, PHA: { value: 72 }, PLA: { value: 104 }, zero: { value: 0 }, one: { value: 1 }, two: { value: 2 }, three: { value: 3 }, four: { value: 4 }, always_on: { value: 1 } },
...
const StackCPU = circuit('StackCPU', {
  in: { reset: bit },
  ...
  nodes: { pc_reg: Register, always_on: Constant, pc_inc: Incrementer, zero: Constant, one: Constant, two: Constant, three: Constant, four: Constant, five: Constant, six: Constant, seven: Constant, byte_0: Constant, byte_1: Constant, byte_2: Constant, byte_3: Constant, byte_4: Constant, byte_5: Constant, byte_6: Constant, byte_7: Constant, at_0: Comparator, at_1: Comparator, at_2: Comparator, at_3: Comparator, at_4: Comparator, at_5: Comparator, at_6: Comparator, at_7: Comparator, mux1: Mux, mux2: Mux, mux3: Mux, mux4: Mux, mux5: Mux, mux6: Mux, mux7: Mux, ir: Register, operand_reg: Register, addr_lo_reg: Register, addr_hi_reg: Register, addr_with_x: Adder, control: StackControl, pc_next: Mux, registers: RegisterFile, sp: StackPointer, sp_init: Constant, stack: StackMemory, effective_addr: Mux, effective_addr_final: Mux, memory: SimpleMemory, inc_x: Incrementer, result_a_imm_zp: Mux, result_a_abs: Mux, result_a_abs_x: Mux, result_a: Mux, result_x: Mux },
  nodeArgs: { always_on: { value: 1 }, zero: { value: 0 }, one: { value: 1 }, two: { value: 2 }, three: { value: 3 }, four: { value: 4 }, five: { value: 5 }, six: { value: 6 }, seven: { value: 7 }, byte_0: { value: 169 }, byte_1: { value: 66 }, byte_2: { value: 72 }, byte_3: { value: 169 }, byte_4: { value: 0 }, byte_5: { value: 104 }, byte_6: { value: 0 }, byte_7: { value: 0 }, sp_init: { value: 255 } },
...
const StackOpsTest = circuit('StackOpsTest', {
  nodes: { cpu: StackCPU, reset_input: Input, d_pc: HexDisplay, d_instruction: HexDisplay, d_operand: HexDisplay, d_address: HexDisplay, d_mem_data: HexDisplay, d_stack_data: HexDisplay, d_state: HexDisplay, d_subcycle: HexDisplay, d_a: HexDisplay, d_x: HexDisplay, d_sp: HexDisplay },
