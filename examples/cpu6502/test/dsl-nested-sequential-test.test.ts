...
`;
    ...
    const comboResult = runCombinationalSimulation(testCircuit);
    ...
    // Run one tick
    console.log('\n=== Running Tick 1 ===');
    const tick1 = runSimulationTick(testCircuit, seqState);
    ...
    const tick2 = runSimulationTick(testCircuit, seqState);
