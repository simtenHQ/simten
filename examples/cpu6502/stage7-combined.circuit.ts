...
const ROM16K = circuit('ROM16K', {
  in: { addr_lo: bus(8), addr_hi: bus(8) },
  out: { data_out: bus(8), responds: bit },
  nodes: { c0: Constant, addr_hi_cmp: Comparator, not_lt: Not, addr_combine: AddressCombiner, rom: ROM },
  nodeArgs: { c0: { value: 192 }, rom: { data: {"49152":56,"49153":120,"49154":8,"49155":24,"49156":88,"49157":40,"49158":169,"49159":15,"49160":41,"49161":240,"49162":9,"49163":240,"49164":200,"49165":200,"49166":202,"49167":234,"65532":0,"65533":192} } },
...
const MemoryBus = circuit('MemoryBus', {
  in: { addr_lo: bus(8), addr_hi: bus(8), data_in: bus(8), rw: bit },
  out: { data_out: bus(8) },
  nodes: { ram: RAM2K, rom: ROM16K, not_rw: Not, ram_we: And, open_bus: Register, data_mux_ram: Mux, data_mux_rom: Mux, any_device: Or, open_bus_we: And },
...
const MemoryBusTest = circuit('MemoryBusTest', {
  nodes: { mem_bus: MemoryBus, addr_lo_in: Input, addr_hi_in: Input, data_in: Input, rw_in: Input, d_data_out: HexDisplay },
...
const System6502 = circuit('System6502', {
  in: { reset: bit },
  out: { pc: bus(8), pc_hi: bus(8), instruction: bus(8), reg_a: bus(8), reg_x: bus(8), reg_y: bus(8), reg_sp: bus(8), flag_n: bit, flag_z: bit, flag_c: bit, flag_v: bit, flag_d: bit, flag_i: bit, addr_lo: bus(8), addr_hi: bus(8), data_bus: bus(8), rw: bit },
...
const CPU6502Test = circuit('CPU6502Test', {
  nodes: { system: System6502, reset_input: Input, d_pc_lo: HexDisplay, d_pc_hi: HexDisplay, d_instruction: HexDisplay, d_a: HexDisplay, d_x: HexDisplay, d_y: HexDisplay, d_sp: HexDisplay, d_addr_lo: HexDisplay, d_addr_hi: HexDisplay, d_data: HexDisplay, d_c: HexDisplay, d_z: HexDisplay, d_n: HexDisplay },
