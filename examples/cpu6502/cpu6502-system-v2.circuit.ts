...
const AddressDecode = circuit('AddressDecode', {
  in: { addr_lo: bus(8), addr_hi: bus(8), rw: bit },
  out: { ram_cs: bit, rom_cs: bit, console_cs: bit, ram_we: bit, console_we: bit },
  nodes: { eight: Constant, ram_range: Comparator, c0: Constant, f0: Constant, rom_range: Comparator, rom_ge_c0: Not, io_check: Comparator, not_io_region: Not, rom_select: And, zero: Constant, console_lo_check: Comparator, console_select: And, not_rw: Not, ram_write: And, console_write: And },
  nodeArgs: { eight: { value: 8 }, c0: { value: 192 }, f0: { value: 240 }, zero: { value: 0 } },
...
const DataMux = circuit('DataMux', {
  in: { ram_data: bus(8), rom_data: bus(8), ram_cs: bit, rom_cs: bit, console_cs: bit, rw: bit },
  out: { data_out: bus(8) },
  nodes: { open_bus: Register, zero: Constant, mux_ram: Mux, mux_console: Mux, mux_rom: Mux, any_ram_rom: Or, any_device: Or, open_bus_we: And },
...
const CPU6502Test = circuit('CPU6502Test', {
  nodes: { cpu: CPU6502Core, ram: RAM, rom: ROM, console: Console, decode: AddressDecode, data_mux: DataMux, addr_combine: AddressCombiner, reset_input: Input },
  nodeArgs: { ram: { addressWidth: 11, dataWidth: 8 }, rom: { baseAddress: 49152 } },
