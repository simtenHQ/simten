...
const Part4TestCPU = component('Part4TestCPU')
  .in('reset', bit)
  .out('pc', bus(8))
  .out('reg_a', bus(8))
  .out('reg_x', bus(8))
  ...
  .node('byte_2', Constant, { value: 169 })
  .node('byte_3', Constant, { value: 80 })
  .node('byte_4', Constant, { value: 56 })
  .node('byte_5', Constant, { value: 233 })
  .node('byte_6', Constant, { value: 16 })
  .node('byte_7', Constant, { value: 233 })
  .node('byte_8', Constant, { value: 48 })
  .node('byte_9', Constant, { value: 233 })
  .node('byte_10', Constant, { value: 16 })
  .node('byte_11', Constant, { value: 169 })
  .node('byte_12', Constant, { value: 5 })
  .node('byte_13', Constant, { value: 233 })
  .node('byte_14', Constant, { value: 16 })
...
const Part4Test = component('Part4Test')
