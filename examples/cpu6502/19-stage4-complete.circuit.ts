...
const Stage4Control = component('Stage4Control')
  .in('reset', bit)
...
const Stage4CPU = component('Stage4CPU')
  .in('reset', bit)
  .out('pc', bus(8))
  ...
  .node('byte_1', Constant, { value: 0 })
  .node('byte_2', Constant, { value: 32 })
  .node('byte_3', Constant, { value: 16 })
  .node('byte_4', Constant, { value: 0 })
  .node('byte_5', Constant, { value: 133 })
  .node('byte_6', Constant, { value: 32 })
  .node('byte_7', Constant, { value: 0 })
  .node('byte_8', Constant, { value: 0 })
  .node('byte_9', Constant, { value: 0 })
  ...
  .node('byte_16', Constant, { value: 169 })
  .node('byte_17', Constant, { value: 66 })
  .node('byte_18', Constant, { value: 96 })
  .node('byte_19', Constant, { value: 0 })
  ...
  .connect(({ in: inp, out, pc_reg, always_on, pc_inc, zero, one, two, three, four, five, six, seven, eight, nine, ten, eleven, twelve, thirteen, fourteen, fifteen, sixteen, seventeen, eighteen, nineteen, byte_0, byte_1, byte_2, byte_3, byte_4, byte_5, byte_6, byte_7, byte_8, byte_9, byte_10, byte_11, byte_12, byte_13, byte_14, byte_15, byte_16, byte_17, byte_18, byte_19, at_0, at_1, at_2, at_3, at_4, at_5, at_6, at_7, at_8, at_9, at_10, at_11, at_12, at_13, at_14, at_15, at_16, at_17, at_18, at_19, mux1, mux2, mux3, mux4, mux5, mux6, mux7, mux8, mux9, mux10, mux11, mux12, mux13, mux14, mux15, mux16, mux17, mux18, mux19, ir, operand_reg, addr_lo_reg, addr_hi_reg, pc_lo_temp, pc_hi_temp, addr_with_x, control, registers, sp, sp_init, stack, pc_minus_1, one_const, stack_data_pha_or_lo, stack_data_final, effective_addr, effective_addr_final, memory, inc_x, rts_pc_plus1, result_a_imm_zp, result_a_abs, result_a_abs_x, result_a, result_x, pc_after_inc, pc_after_rts, pc_after_jsr }) => [
    ...
    at_19.eq.to(mux19.sel),
    mux18.out.to(mux19.in0),
    byte_19.out.to(mux19.in1),
    mux19.out.to(ir.data, operand_reg.data, addr_lo_reg.data, addr_hi_reg.data),
...
const Stage4Test = component('Stage4Test')
  .node('cpu', Stage4CPU)
