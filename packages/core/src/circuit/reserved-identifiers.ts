...
export const RESERVED_IDENTIFIERS: ReadonlySet<string> = new Set([
  ...
  'top', 'self', 'parent', 'window', 'document', 'name', 'length', 'status',
  'origin', 'closed', 'frames', 'location', 'history', 'navigator', 'event',
  'screen', 'external', 'menubar', 'toolbar', 'locationbar', 'personalbar',
  'scrollbars', 'statusbar', 'frameElement', 'opener', 'globalThis',
]);
