...
export const RV32I_Decode = component('RV32I_Decode', {
...
export const RV32I_BranchComp = component('RV32I_BranchComp', {
  in: { a: bus(32), b: bus(32), funct3: bus(3) },
  out: { take_branch: bit },
  meta: { category: 'rv32i', description: 'RISC-V branch comparator' },
});

export const RV32I_RegisterFile = component('RV32I_RegisterFile', {
...
export const RV32I_InstrMem = component('RV32I_InstrMem', {
  in: { addr: bus(32) },
...
export const RV32I_DataMem = component('RV32I_DataMem', {
...
export const RV32I_WritebackMux = component('RV32I_WritebackMux', {
...
export const RV32I_NextPCMux = component('RV32I_NextPCMux', {
...
export const RV32I_ForwardingUnit = component('RV32I_ForwardingUnit', {
...
export const RV32I_WBBypass = component('RV32I_WBBypass', {
...
export const RV32I_LoadAlign = component('RV32I_LoadAlign', {
  in: { data: bus(32), funct3: bus(3) },
  out: { out: bus(32) },
  meta: { category: 'rv32i', description: 'RISC-V load alignment (byte/half/word)' },
});

export const RV32I_HazardUnit = component('RV32I_HazardUnit', {
...
export const DualPortROM = component('DualPortROM', {
