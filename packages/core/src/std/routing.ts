...
export const Splitter8to8 = circuit('Splitter8to8', {
  inputs: { in: bus(8) },
  outputs: { bit0: bit, bit1: bit, bit2: bit, bit3: bit, bit4: bit, bit5: bit, bit6: bit, bit7: bit },
...
export const Combiner8to8 = circuit('Combiner8to8', {
  inputs: { bit0: bit, bit1: bit, bit2: bit, bit3: bit, bit4: bit, bit5: bit, bit6: bit, bit7: bit },
  outputs: { out: bus(8) },
