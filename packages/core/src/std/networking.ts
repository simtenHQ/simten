...
export const Eth_ProtocolDecoder = component('Eth_ProtocolDecoder', {
  in: { ethertype: bus(16) },
...
export const Eth_AddrClassifier = component('Eth_AddrClassifier', {
...
export const Eth_FrameInput = component('Eth_FrameInput', {
...
export const Eth_FrameParser = component('Eth_FrameParser', {
...
export const Eth_CRC32 = component('Eth_CRC32', {
...
export const MemBusMux = component('MemBusMux', {
...
export const UART_TX = component('UART_TX', {
...
export const NIC_FIFO = component('NIC_FIFO', {
