/**
 * RasterDisplayNode Component
 *
 * Renders a hardware-accurate 8x8 raster display with scan counters.
 * Unlike Screen (which uses burst DMA), RasterDisplay captures pixels
 * during sequential scanning, simulating real CRT/LCD display timing.
 *
 * Features:
 * - Sequential raster scanning (one pixel per clock)
 * - VBLANK/HBLANK sync signals
 * - Scan position counters (scanX, scanY)
 * - Pixel data captured during active scan
 */
