      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div className="px-6 py-4">
          <p className="text-sm text-gray-700 mb-4">
            Both the circuit code and the canvas have been modified since the last sync. Please
          ...
          <div className="space-y-3">
            <div className="p-3 bg-blue-50 border border-blue-200 rounded">
              ...
              <p className="text-xs text-blue-700">
                The canvas will be updated to match the current circuit code. Any canvas-only
            ...
            <div className="p-3 bg-green-50 border border-green-200 rounded">
              ...
              <p className="text-xs text-green-700">
                The circuit code will be regenerated from the current canvas state. Any code-only
                changes will be lost.
              </p>
            </div>
          </div>
        ...
        <div className="flex gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50">
          ...
          <Button onClick={onKeepCode} className="flex-1 bg-blue-600 hover:bg-blue-700 text-white">
            Keep Code
          </Button>
          <Button
