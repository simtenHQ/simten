...
import { compileDSL, type ComponentLibrary, type Circuit } from '@turing-incomplete/core/dsl';
import { useComponentLibraryStore } from '../../editor/stores/component-library-store';
import { useMemoryDataStore } from '../../editor/stores/memory-data-store';
import { getPrimitives } from '../../editor/lib/primitive-registry';
import { elaborate } from '../../editor/lib/elaboration';
import {
  createSimulator,
