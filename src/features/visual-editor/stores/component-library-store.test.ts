 ...
 *
 * Comprehensive test suite for the component library management system.
 */
...
describe('Component Library Store', () => {
  ...
  describe('Primitive Operations', () => {
    it('should register a primitive component', () => {
      const store = useComponentLibraryStore.getState();
  ...
  describe('Standard Library Operations', () => {
    it('should register a standard component', () => {
      const store = useComponentLibraryStore.getState();
    ...
    it('should retrieve undefined for non-existent standard component', () => {
      const store = useComponentLibraryStore.getState();
      const result = store.getStandard('NonExistent');
      expect(result).toBeUndefined();
    });

    it('should register multiple standard components in bulk', () => {
      const store = useComponentLibraryStore.getState();
      const circuits = [
  ...
  describe('User Component Operations', () => {
    it('should register a user component', () => {
      const store = useComponentLibraryStore.getState();
    ...
    it('should remove a user component', () => {
      const store = useComponentLibraryStore.getState();
      const myCircuit = createTestCircuit('MyCircuit');
    ...
    it('should handle removing non-existent user component', () => {
      const store = useComponentLibraryStore.getState();
    ...
    it('should get all user component names sorted', () => {
      const store = useComponentLibraryStore.getState();
  ...
  describe('Unified Resolution', () => {
    it('should resolve primitives first', () => {
      ...
      const resolved = store.resolveComponent('And');
    ...
    it('should resolve standard library second', () => {
      ...
      const resolved = store.resolveComponent('HalfAdder');
      expect(resolved?.id).toBe('test:HalfAdder'); // Standard wins
    });

    it('should resolve user components third', () => {
      const store = useComponentLibraryStore.getState();
      const user = createTestCircuit('MyCircuit');

      store.registerUser(user);

      const resolved = store.resolveComponent('MyCircuit');
      expect(resolved?.id).toBe('test:MyCircuit');
    });

    it('should return undefined for unresolvable component', () => {
      const store = useComponentLibraryStore.getState();
      const resolved = store.resolveComponent('NonExistent');
  ...
  describe('Query Operations', () => {
    it('should get all component names from all libraries', () => {
      const store = useComponentLibraryStore.getState();
      ...
      const allNames = store.getAllComponentNames();
    ...
    it('should handle empty libraries', () => {
      ...
      expect(store.getAllComponentNames()).toEqual([]);
    });
  });

  describe('Clear Operations', () => {
    it('should clear only user components', () => {
      const store = useComponentLibraryStore.getState();
  ...
  describe('Complex Scenarios', () => {
    it('should handle component with bus ports', () => {
      const store = useComponentLibraryStore.getState();
