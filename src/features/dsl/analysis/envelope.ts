...
import { extractBehavioralDiagnostics } from './simulate';
import { buildComponentCatalog } from '../validation/validate';
import { getGrammarSummary } from '../validation/catalog';
