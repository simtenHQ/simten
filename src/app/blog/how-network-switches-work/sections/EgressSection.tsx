...
export function EgressSection() {
  const circuit = SWITCH_CIRCUITS.packetSerializer;
    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-300 leading-relaxed">
          ...
          <strong className="text-white">egress controller</strong> reads it
          back out one byte at a time. A{" "}
          <strong className="text-white">read pointer</strong> register steps
