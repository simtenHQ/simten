...
The full documentation lives at **[simten.dev/docs](https://simten.dev/docs)** — the canonical reading experience, with interactive diagrams, embedded circuit demos, and pipeline visualizations.

Markdown source is at [`apps/web/content/docs/`](../apps/web/content/docs/) (MDX) and is editable on GitHub. Topics covered:

- [Architecture](https://simten.dev/docs/architecture) — pipeline from `circuit()` to simulation, IR types, packages, hooks, store layout
