...
export function buildSnakeAdvanced() {
  const SnakeAdvanced = circuit('SnakeAdvanced', {
    ...
    nodes: {
      ...
      foodX: Register({ value: 6 }), foodY: Register({ value: 3 }), foodNeedsDrawing: Register({ value: 1 }),
      headPtr: Register({ value: 3 }), tailPtr: Register({ value: 0 }), snakeLen: Register({ value: 4 }),
      headX: Register({ value: 4 }), headY: Register({ value: 4 }),
      tailPixelAddr: Register({ value: 33 }), nextHeadPixelAddr: Register({ value: 36 }),
      phase: Register({ value: 0 }), keyboardLatched: Register({ value: 1 }),
      zero: Constant({ value: 0 }), one: Constant({ value: 1 }), two: Constant({ value: 2 }), three: Constant({ value: 3 }),
      bodyBase: Constant({ value: 64 }), minus1: Constant({ value: 255 }), five: Constant({ value: 5 }),
      phaseInc: Adder(), phaseWrap: BitSlice({ low: 0, high: 1 }),
      phaseEnable: Constant({ value: 1 }),
