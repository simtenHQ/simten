...
const SnakeAdvanced = circuit('SnakeAdvanced', {
  ...
  nodes: { ram: DualPortRAM({ memory: { "33": 1, "34": 1, "35": 1, "36": 1, "64": 33, "65": 34, "66": 35, "67": 36 } }), foodX: Register({ value: 6 }), foodY: Register({ value: 3 }), foodNeedsDrawing: Register({ value: 1 }), headPtr: Register({ value: 3 }), tailPtr: Register({ value: 0 }), snakeLen: Register({ value: 4 }), headX: Register({ value: 4 }), headY: Register({ value: 4 }), tailPixelAddr: Register({ value: 33 }), nextHeadPixelAddr: Register({ value: 36 }), phase: Register({ value: 0 }), zero: Constant({ value: 0 }), one: Constant({ value: 1 }), two: Constant({ value: 2 }), three: Constant({ value: 3 }), bodyBase: Constant({ value: 64 }), minus1: Constant({ value: 255 }), phaseInc: Adder(), phaseWrap: BitSlice({ low: 0, high: 1 }), phaseEnable: Constant({ value: 1 }), isPhase0: Comparator(), isPhase1: Comparator(), isPhase2: Comparator(), isPhase3: Comparator(), keyboardLatched: Register({ value: 1 }), latchKeyboard: And, isUp: Comparator(), isDown: Comparator(), isLeft: Comparator(), isRight: Comparator(), deltaXTemp: Mux({ width: 8 }), deltaX: Mux({ width: 8 }), deltaYTemp: Mux({ width: 8 }), deltaY: Mux({ width: 8 }), nextHeadXCalc: Adder(), nextHeadYCalc: Adder(), nextHeadX: BitSlice({ low: 0, high: 2 }), nextHeadY: BitSlice({ low: 0, high: 2 }), nextHeadY2: Adder(), nextHeadY4: Adder(), nextHeadY8: Adder(), nextPixelAddr: Adder(), foodY2: Adder(), foodY4: Adder(), foodY8: Adder(), foodPixelAddr: Adder(), nextHeadAtFoodX: Comparator(), nextHeadAtFoodY: Comparator(), willEatFood: And, latchNextHead: And, headPtrNext: Adder(), headPtrNextWrap: BitSlice({ low: 0, high: 5 }), headBodyAddr: Adder(), tailBodyAddr: Adder(), phase0Addr: Mux(), addrMux0: Mux(), addrMux1: Mux(), ramAddr: Mux(), dataMux0: Mux(), dataMux1: Mux(), ramData: Mux(), bufferEmpty: Comparator(), bufferNotEmpty: Not, deltaXIsZero: Comparator(), deltaYIsZero: Comparator(), bothDeltasZero: And, isMoving: Not, shouldMoveTail: Constant({ value: 1 }), shouldMoveTailActual: And, notEatingFood: Not, shouldClearTail: And, shouldClearTailMoving: And, writePhase0: And, writePhase1: And, writePhase2: And, writePhase3: And, writePhase01: Or, writePhase2or3: Or, writeAny: Or, writeEnable: Constant({ value: 1 }), finalWriteEnable: And, latchTail: And, latchTailFinal: And, latchTailNotFood: And, notDrawingFood: Not, clearFoodFlag: And, clearFoodFlagFinal: And, ateFood: And, ateFoodFinal: And, foodFlagWriteEnable: Or, foodFlagData: Mux(), foodXNext: Adder(), foodXWrap: BitSlice({ low: 0, high: 2 }), foodYNext: Adder(), five: Constant({ value: 5 }), foodYWrap: BitSlice({ low: 0, high: 2 }), updateHead: And, updateHeadFinal: And, headPtrInc: Adder(), headPtrWrap: BitSlice({ low: 0, high: 5 }), tailPtrInc: Adder(), tailPtrWrap: BitSlice({ low: 0, high: 5 }), updateTail: And, updateTailFinal: And, snakeLenDelta: Mux(), snakeLenNew: Adder() },
