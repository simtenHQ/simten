...
import { Program, SourceRange } from '../../types/ast';
import { DSLLexer } from './tokens';
...
export { DSLLexer } from './tokens';
export { parserInstance as DSLParser } from './parser';
export { visitor as CstToAstVisitor } from './visitor';
