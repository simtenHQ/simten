      ...
      <div className="prose-invert space-y-6">
        ...
        <ul className="text-gray-600 dark:text-gray-300 space-y-2 ml-4">
          ...
          <li className="flex gap-2">
            <span className="text-gray-500 mt-1">–</span>
            <span>
              64 GF(2<sup>8</sup>) multiplications and 48 XORs for MixColumns
            </span>
          </li>
          <li className="flex gap-2">
            <span className="text-gray-500 mt-1">–</span>
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          That&rsquo;s hundreds of operations per round, ten rounds per block, and a timing side
          channel if the S-box lookups hit different cache lines for different key bytes. A
          table-based software AES is fast enough, but it&rsquo;s not <em>safe enough</em> without
