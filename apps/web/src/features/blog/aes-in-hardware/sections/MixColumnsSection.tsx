    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          <strong>MixColumns</strong> treats each 4-byte column of the AES state matrix as a
          polynomial over GF(2<sup>8</sup>) and multiplies it by a fixed matrix. Each output byte
          mixes all four input bytes:
        </p>
