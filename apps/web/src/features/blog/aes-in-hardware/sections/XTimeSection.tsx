    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          , which keeps the result in 8 bits while preserving the multiplicative structure of GF(2
          <sup>8</sup>). Any other reduction would break the field.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          {[
            ...
            >
              ...
              <div className="text-emerald-400">
                {outDec} <span className="text-gray-500">({outHex})</span>
              </div>
            </div>
          ))}
        </div>
