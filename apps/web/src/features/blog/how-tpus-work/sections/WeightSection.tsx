...
export function WeightSection() {
  return (
    <section className="py-12">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">The Weight Register</h2>
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          In a TPU, weights are loaded <em>before</em> data starts flowing. Each processing element
          has a <strong className="text-gray-900 dark:text-white">weight register</strong> that
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          In the real TPUv1, a unified buffer loads weights into all processing elements
          simultaneously. The valid bit is the gating mechanism that tells each PE exactly when to
          capture its weight.
        </p>
      </div>
