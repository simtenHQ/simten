...
export function MACSection() {
  return (
    <section className="py-12">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Multiply and Add</h2>
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <code className="text-blue-300">partialSumIn + data &times; weight</code>. The result
          appears instantly.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
