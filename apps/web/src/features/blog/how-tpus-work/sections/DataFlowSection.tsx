    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          PE0&rsquo;s <code className="text-blue-300">dataIn</code> from the left. After one clock
          cycle, PE0&rsquo;s pipeline register outputs the data, which feeds directly into
          PE1&rsquo;s <code className="text-blue-300">dataIn</code>. Each PE has its own stored
          weight, so the same activation value gets multiplied by different weights as it flows
          across the row.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Both PEs have <code className="text-blue-300">partialSumIn = 0</code> here because
          vertical flow hasn&rsquo;t been introduced yet. Each PE independently computes{' '}
          <code className="text-blue-300">0 + data &times; weight</code>. Load weights into both PEs
