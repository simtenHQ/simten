    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          the fundamental building block of a systolic array. It combines everything we&rsquo;ve
          seen so far into one unit with four parts:
        </p>
        <ol className="text-gray-600 dark:text-gray-300 leading-relaxed list-decimal list-inside space-y-2">
          ...
          <li>
            ...
            delays <code className="text-blue-300">dataIn</code> by one clock cycle to produce{' '}
            <code className="text-blue-300">dataOut</code>, feeding the next PE in the row.
          </li>
        </ol>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
