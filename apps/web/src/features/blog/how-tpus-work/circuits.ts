...
const PE_Systolic = circuit('PE_Systolic', {
  ...
  nodes: {
    weightReg: Register({ width: 8 }),
    mult: Multiplier,
    adder: Adder({ width: 16 }),
    psumReg: Register({ width: 16 }),
    dataPipe: Register({ width: 8 }),
    validPipe: DFlipFlop(),
  ...
  connect: ({
    inputs,
    outputs,
    nodes: { weightReg, mult, adder, psumReg, dataPipe, validPipe, one, zero },
  }) => [
...
const MultiplyAdd = circuit('MultiplyAdd', {
  nodes: {
    data: Input({ value: 3 }),
    weight: Input({ value: 5 }),
    partialSumIn: Input({ value: 10, width: 16 }),
    mult: Multiplier,
    adder: Adder({ width: 16 }),
    zero: Constant({ value: 0 }),
    result: HexDisplay({ width: 16 }),
  },
...
const WeightRegister = circuit('WeightRegister', {
  nodes: {
    weightIn: Input({ value: 7 }),
    weightValid: Switch,
    dataIn: Input({ value: 3 }),
    weightReg: Register(),
    storedWeight: HexDisplay(),
    mult: Multiplier,
    product: HexDisplay({ width: 16 }),
  },
  connect: ({
    nodes: { weightIn, weightValid, dataIn, weightReg, storedWeight, mult, product },
  }) => [
...
const TestPE = circuit('TestPE', {
  nodes: {
    pe: PE_Systolic,
    dataIn: Input({ value: 3 }),
    weightIn: Input({ value: 5 }),
    weightValid: Switch,
    partialSumIn: Input({ value: 0, width: 16 }),
    partialSumOut: HexDisplay({ width: 16 }),
    dataOut: HexDisplay(),
  },
  connect: ({
    nodes: { pe, dataIn, weightIn, weightValid, partialSumIn, partialSumOut, dataOut },
  }) => [
...
const TwoPERow = circuit('TwoPERow', {
  nodes: {
    ...
    pe1: PE_Systolic,
    data0: Input({ value: 2 }),
    weight0: Input({ value: 3 }),
    weight1: Input({ value: 5 }),
    weightValid: Switch,
    zero16: Constant({ value: 0 }),
    result0: HexDisplay({ width: 16 }),
    result1: HexDisplay({ width: 16 }),
  },
  connect: ({
    nodes: { pe0, pe1, data0, weight0, weight1, weightValid, zero16, result0, result1 },
  }) => [
...
const TwoPEColumn = circuit('TwoPEColumn', {
  nodes: {
    pe0: PE_Systolic,
    pe1: PE_Systolic,
    dataIn: Input({ value: 4 }),
    weight0: Input({ value: 3 }),
    weight1: Input({ value: 5 }),
    weightValid: Switch,
    zero16: Constant({ value: 0 }),
    topResult: HexDisplay({ width: 16 }),
    bottomResult: HexDisplay({ width: 16 }),
  },
  connect: ({
    nodes: { pe0, pe1, dataIn, weight0, weight1, weightValid, zero16, topResult, bottomResult },
  }) => [
...
export const Systolic2x2 = circuit('Systolic2x2', {
  ...
  nodes: {
    ...
    muxR1a: Mux(),
    muxR1b: Mux(),
    result_c00: Register({ width: 16 }),
    result_c10: Register({ width: 16 }),
    result_c01: Register({ width: 16 }),
    result_c11: Register({ width: 16 }),
    isDone: Comparator(),
  },
  connect: ({
    inputs,
...
export const TestWavefront = circuit('TestWavefront', {
  nodes: {
    ...
    b11: Input({ value: 8 }),
    start: Switch,
    display_c00: HexDisplay({ width: 16 }),
    display_c01: HexDisplay({ width: 16 }),
    display_c10: HexDisplay({ width: 16 }),
    display_c11: HexDisplay({ width: 16 }),
    done_led: Led,
  },
  connect: ({
    nodes: {
...
const Systolic3x3 = circuit('Systolic3x3', {
  ...
  nodes: {
    ...
    r2validA: Or,
    r2valid: Or,
    col0validD: DFlipFlop(),
    col0psumD: Register({ width: 16 }),
    col0count: Register({ value: 0 }),
    col0countInc: Incrementer,
    col0is0: Comparator(),
    col0is1: Comparator(),
    col0is2: Comparator(),
    c00we: And,
    ...
    result_c10: Register({ width: 16 }),
    c20we: And,
    result_c20: Register({ width: 16 }),
    col1validD: DFlipFlop(),
    col1psumD: Register({ width: 16 }),
    col1count: Register({ value: 0 }),
    col1countInc: Incrementer,
    col1is0: Comparator(),
    col1is1: Comparator(),
    col1is2: Comparator(),
    c01we: And,
    ...
    result_c11: Register({ width: 16 }),
    c21we: And,
    result_c21: Register({ width: 16 }),
    col2validD: DFlipFlop(),
    col2psumD: Register({ width: 16 }),
    col2count: Register({ value: 0 }),
    col2countInc: Incrementer,
    col2is0: Comparator(),
    col2is1: Comparator(),
    col2is2: Comparator(),
    c02we: And,
    result_c02: Register({ width: 16 }),
    c12we: And,
    result_c12: Register({ width: 16 }),
    c22we: And,
    result_c22: Register({ width: 16 }),
    col0done: Comparator(),
    col1done: Comparator(),
    col2done: Comparator(),
    doneAnd1: And,
...
export const TestSystolic3x3 = circuit('TestSystolic3x3', {
  ...
  nodes: {
    ...
    display_c00: HexDisplay({ width: 16 }),
    display_c01: HexDisplay({ width: 16 }),
    display_c02: HexDisplay({ width: 16 }),
    display_c10: HexDisplay({ width: 16 }),
    display_c11: HexDisplay({ width: 16 }),
    display_c12: HexDisplay({ width: 16 }),
    display_c20: HexDisplay({ width: 16 }),
    display_c21: HexDisplay({ width: 16 }),
    display_c22: HexDisplay({ width: 16 }),
    done_led: Led,
  },
  connect: ({
    outputs,
