...
const TestPE = circuit('TestPE', {
  nodes: {
    ...
    weightValid: Switch(),
    partialSumIn: Input({ value: 0 }),
    partialSumOut: HexDisplay,
    dataOut: HexDisplay,
  },
  connect: ({
...
const TwoPEColumn = circuit('TwoPEColumn', {
  nodes: {
    ...
    weightValid: Switch(),
    zero16: Constant({ value: 0 }),
    topResult: HexDisplay,
    bottomResult: HexDisplay,
  },
  connect: ({
...
export const TestWavefront = circuit('TestWavefront', {
  nodes: {
    ...
    b11: Input({ value: 8 }),
    start: Switch(),
    display_c00: HexDisplay,
    display_c01: HexDisplay,
    display_c10: HexDisplay,
    display_c11: HexDisplay,
    done_led: Led,
  },
  connect: ({
    nodes: {
...
export const TestSystolic3x3 = circuit('TestSystolic3x3', {
  ...
  nodes: {
    ...
    display_c00: HexDisplay,
    display_c01: HexDisplay,
    display_c02: HexDisplay,
    display_c10: HexDisplay,
    display_c11: HexDisplay,
    display_c12: HexDisplay,
    display_c20: HexDisplay,
    display_c21: HexDisplay,
    display_c22: HexDisplay,
    done_led: Led,
  },
  connect: ({
    outputs,
