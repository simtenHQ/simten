    ...
    <section className="py-8 md:py-12">
      ...
      <ClientOnly>
        <Suspense
          fallback={
            <div
              className="rounded-xl border border-gray-700/50 bg-gray-100/50 dark:bg-gray-900/50 p-8 mb-8"
              style={{ minHeight: 400 }}
            >
      ...
      <div className="max-w-3xl">
        <p className="text-xl text-gray-500 dark:text-gray-300 leading-relaxed">
          This whole thing runs without a CPU. Every move the snake makes is decided by wires and
          gates, all at once, on each clock tick. It&rsquo;s about 100 nodes of logic, registers,
          and memory, all written in TypeScript and simulated live in your browser. The same code
          exports to Verilog. Here&rsquo;s how it works.
        </p>
