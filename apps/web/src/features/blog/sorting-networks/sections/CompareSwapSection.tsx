    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <strong>compare-and-swap</strong>. Give it two values and it always puts the smaller on{' '}
          <code>lo</code> and the larger on <code>hi</code>. If the inputs are already in order,
          nothing changes. If they are out of order, they are swapped. Either way, the operation
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Try changing inputs <strong>a</strong> and <strong>b</strong> below. No matter what values
          you enter, <code>lo</code> always shows the smaller and <code>hi</code> always shows the
          larger.
        </p>
      </div>
