    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Now we chain four ARX steps together, each feeding into the next. The quarter-round takes
          four 32-bit words (a, b, c, d) and thoroughly mixes them:
        </p>
...
c += d;  b ^= c;  b <<<= 7;`}
      ...
      <div className="mt-8 rounded-lg border border-green-800/50 bg-green-950/20 p-4">
        <p className="text-sm text-green-400 font-medium">Verified against RFC 7539 &sect;2.1.1</p>
