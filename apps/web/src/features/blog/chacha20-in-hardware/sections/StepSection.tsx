    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          Each of the four steps in a quarter-round chains the three operations together. Take the
          first step:
        </p>
...
d <<<= 16; // rotate d left by 16`}
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          feeds the <code>BusXor</code>, which feeds the <code>RotateLeft16</code>. Change any input
          (decimal) and the entire chain recomputes instantly.
        </p>
      </div>
