...
export function BreakoutSection() {
  return (
    <section className="py-12">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">The Full Game</h2>
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          All the pieces come together: paddle input, ball physics, brick collision, and the
          combinational raster scan. 128 bricks across the top four rows, a ball that bounces off
          walls, paddle, and bricks, and a 6-pixel paddle you control with arrow keys.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
