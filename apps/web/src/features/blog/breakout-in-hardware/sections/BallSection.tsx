    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          The ball has four registers: X position, Y position, X velocity (1 or 255 for right/left),
          and Y velocity (1 or 255 for down/up). Each clock, the next position is computed by adding
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          X=0 moving left, the velocity flips to +1 first, then the new position is computed. This
          prevents the ball from wrapping around to the other side of the screen.
        </p>
      </div>
    </section>
  );
