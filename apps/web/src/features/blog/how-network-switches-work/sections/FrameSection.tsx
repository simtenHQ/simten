    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          states: <em>Idle</em> (0), <em>Waiting for SFD</em> (1), and <em>In Frame</em> (2). The
          state is stored in a register and updated each clock tick based on what byte arrives.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
