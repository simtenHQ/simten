...
export function RouterSection() {
  ...
  return (
    <section className="py-12">
      <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Crossbar Routing</h2>
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <code>Mux</code> selects 1 as the destination (and the <strong>routedLed</strong> lights
          up). Otherwise, it selects 0.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
