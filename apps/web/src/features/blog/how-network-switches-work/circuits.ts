...
const FrameDetector = circuit('FrameDetector', {
  nodes: {
    ...
    isPreamble: Comparator(),
    isSFD: Comparator(),
    isIdle: Comparator(),
    isWaiting: Comparator(),
    isActive: Comparator(),
    gotPreamble: And,
    gotPreambleValid: And,
    gotSFD: And,
    gotSFDValid: And,
    next1: Mux(),
    next2: Mux(),
    we: Input({ value: 1 }),
    stateDisplay: HexDisplay,
    frameLed: Led,
  },
  connect: ({
    nodes: {
...
const PacketBuffer = circuit('PacketBuffer', {
  nodes: {
    ...
    ram: DualPortRAM(),
    nextPtr: Adder(),
    readAddr: Input({ value: 0 }),
    readback: HexDisplay,
    ptrDisplay: HexDisplay,
  },
  connect: ({
    nodes: { dataIn, writeCmd, writePtr, one, ram, nextPtr, readAddr, readback, ptrDisplay },
  }) => [
...
const CrossbarRouter = circuit('CrossbarRouter', {
  nodes: {
    sourcePort: Input({ value: 0 }),
    zero: Constant({ value: 0 }),
    one: Constant({ value: 1 }),
    isPort0: Comparator(),
    destPort: Mux(),
    destDisplay: HexDisplay,
    srcDisplay: HexDisplay,
    routedLed: Led,
  },
  connect: ({
    nodes: { sourcePort, zero, one, isPort0, destPort, destDisplay, srcDisplay, routedLed },
  }) => [
...
const PacketSerializer = circuit('PacketSerializer', {
  ...
  connect: ({
    nodes: { ram, readPtr, one, seven, nextPtr, enable, dataOut, ptrDisplay, isDone, doneLed },
  }) => [
...
const MacRxParser = circuit('MacRxParser', {
  ...
  nodes: {
    fsm_state: Register(),
    preamble_count: Register(),
    byte_count: Register(),
    STATE_IDLE: Input({ value: 0 }),
    STATE_PREAMBLE_SYNC: Input({ value: 1 }),
    STATE_WAIT_SFD: Input({ value: 2 }),
    STATE_IN_FRAME: Input({ value: 3 }),
    PREAMBLE_BYTE: Input({ value: 85 }),
    SFD_BYTE: Input({ value: 213 }),
    SEVEN: Input({ value: 7 }),
    EIGHT: Input({ value: 8 }),
    ZERO: Input({ value: 0 }),
    ONE: Input({ value: 1 }),
    SIX: Input({ value: 6 }),
    isIDLE: Comparator(),
    isPREAMBLE_SYNC: Comparator(),
    isWAIT_SFD: Comparator(),
    isIN_FRAME: Comparator(),
    isPreambleByte: Comparator(),
    isSFDByte: Comparator(),
    preamble_inc: Adder(),
    preamble_is_seven: Comparator(),
    byte_inc: Adder(),
    byte_is_seven: Comparator(),
    byte_is_zero: Comparator(),
    idle_to_preamble: And,
    idle_transition: And,
    preamble_count_full: And,
    preamble_to_wait: And,
    preamble_to_wait_match: And,
    not_preamble_byte: Not,
    preamble_incomplete: Comparator(),
    preamble_bad_byte: And,
    preamble_broken: And,
    preamble_reset: And,
    preamble_got_sfd: And,
    preamble_complete: And,
    preamble_to_frame: And,
    sfd_to_frame: And,
    sfd_transition: And,
    sfd_missing: And,
    not_sfd_byte: Not,
    ...
    error_reset: Or,
    next_state: Mux(),
    fsm_state_we: Input({ value: 1 }),
    preamble_counting: And,
    next_preamble_count: Mux(),
    preamble_count_we: Input({ value: 1 }),
    byte_counting: And,
    next_byte_count: Mux(),
    byte_count_we: Input({ value: 1 }),
    sof_condition: And,
    data_valid_signal: And,
    fsm_state_display: HexDisplay,
    preamble_count_display: HexDisplay,
    byte_count_display: HexDisplay,
  },
  connect: ({
    inputs,
    outputs,
    ...
    preamble_count.q.to(
      preamble_inc.a,
      preamble_is_seven.a,
      preamble_incomplete.a,
      preamble_count_display.in,
    ),
    ...
    isPREAMBLE_SYNC.eq.to(
      preamble_count_full.a,
      preamble_broken.a,
      preamble_complete.a,
      preamble_counting.a,
    ),
...
const IngressController = circuit('IngressController', {
  ...
  nodes: {
    fsm_state: Register(),
    byte_count: Register(),
    write_ptr_reg: Register(),
    pkt_count: Register(),
    pkt_ready_reg: Register(),
    STATE_IDLE: Input({ value: 0 }),
    STATE_RECEIVING: Input({ value: 1 }),
    STATE_BUFFERED: Input({ value: 2 }),
    ZERO: Input({ value: 0 }),
    ONE: Input({ value: 1 }),
    FOUR: Input({ value: 4 }),
    SEVEN: Input({ value: 7 }),
    EIGHT: Input({ value: 8 }),
    isIDLE: Comparator(),
    isRECEIVING: Comparator(),
    isBUFFERED: Comparator(),
    buf_full_cmp: Comparator(),
    not_buf_full: Not,
    can_receive: And,
    can_receive_valid: And,
    idle_to_receiving: And,
    byte_is_seven: Comparator(),
    frame_complete: And,
    receiving_complete: And,
    receiving_complete_valid: And,
    buffered_to_idle: And,
    next_state_m2: Mux(),
    next_state_m1: Mux(),
    next_state: Mux(),
    fsm_state_we: Input({ value: 1 }),
    ...
    byte_count_we: Input({ value: 1 }),
    ptr_add_eight: Adder(),
    should_advance_ptr: And,
    next_write_ptr_val: Mux(),
    write_ptr_reg_we: Input({ value: 1 }),
    pkt_inc: Adder(),
    pkt_dec: Adder(),
    MINUS_ONE: Input({ value: 255 }),
    next_pkt_count_inc: Mux(),
    next_pkt_count: Mux(),
    pkt_count_we: Input({ value: 1 }),
    buf_addr_calc: Adder(),
    buf_we_signal: And,
    pkt_count_nonzero: Comparator(),
    pkt_ready_signal: Or,
    pkt_ready_we: Input({ value: 1 }),
    fsm_state_display: HexDisplay,
    pkt_count_display: HexDisplay,
    write_ptr_debug: HexDisplay,
  },
  connect: ({
    inputs,
    outputs,
    ...
    pkt_count.q.to(
      ...
      pkt_inc.a,
      pkt_dec.a,
      next_pkt_count_inc.in0,
      pkt_count_nonzero.a,
      pkt_count_display.in,
    ),
    ...
    inputs.data_valid.to(
      can_receive_valid.b,
      receiving_complete_valid.b,
      should_count.b,
      buf_we_signal.b,
    ),
    ...
    next_state_m1.out.to(next_state.in0),
    buffered_to_idle.out.to(
      next_state.sel,
      should_advance_ptr.a,
      should_advance_ptr.b,
      next_pkt_count.sel,
    ),
    next_state.out.to(fsm_state.data),
    fsm_state_we.out.to(fsm_state.we),
...
const SimpleArbiter2Port = circuit('SimpleArbiter2Port', {
  ...
  nodes: {
    last_port: Register(),
    grant_port_reg: Register(),
    grant_valid_reg: Register(),
    ZERO: Input({ value: 0 }),
    ONE: Input({ value: 1 }),
    last_was_port0: Comparator(),
    last_was_port1: Comparator(),
    prefer_port1: And,
    not_port1_ready: Not,
    fallback_port0: And,
    fallback_port0_ready: And,
    prefer_port0: And,
    not_port0_ready: Not,
    fallback_port1: And,
    fallback_port1_ready: And,
    grant_port0_signal: Or,
    grant_port1_signal: Or,
    grant_valid_signal: Or,
    grant_port_mux: Mux(),
    grant_valid_we: Input({ value: 1 }),
    grant_port_we: Input({ value: 1 }),
    next_last_port: Mux(),
    last_port_we: Input({ value: 1 }),
    last_port_display: HexDisplay,
  },
  connect: ({
    inputs,
    outputs,
    nodes: {
      ...
      not_port1_ready,
      fallback_port0,
      fallback_port0_ready,
      prefer_port0,
      not_port0_ready,
      fallback_port1,
      fallback_port1_ready,
      grant_port0_signal,
      grant_port1_signal,
      grant_valid_signal,
      grant_port_mux,
...
const PacketForwarder2Port = circuit('PacketForwarder2Port', {
  ...
  nodes: {
    fsm_state: Register(),
    byte_counter: Register(),
    output_port_reg: Register(),
    ingress_port_reg: Register(),
    done_reg: Register(),
    STATE_IDLE: Input({ value: 0 }),
    STATE_READ_HEADER: Input({ value: 1 }),
    STATE_WAIT_HEADER: Input({ value: 2 }),
    STATE_ROUTE: Input({ value: 3 }),
    STATE_COPY_PAYLOAD: Input({ value: 4 }),
    STATE_DONE: Input({ value: 5 }),
    ZERO: Input({ value: 0 }),
    ONE: Input({ value: 1 }),
    SEVEN: Input({ value: 7 }),
    EIGHT: Input({ value: 8 }),
    DA_MASK: Input({ value: 240 }),
    DA_SHIFT: Input({ value: 4 }),
    isIDLE: Comparator(),
    isREAD_HEADER: Comparator(),
    isWAIT_HEADER: Comparator(),
    isROUTE: Comparator(),
    isCOPY_PAYLOAD: Comparator(),
    isDONE: Comparator(),
    idle_to_read: And,
    read_to_wait: And,
    wait_to_route: And,
    ...
    next_state: Mux(),
    fsm_state_we: Input({ value: 1 }),
    latch_ingress_port: And,
    next_ingress_port_val: Mux(),
    ingress_port_reg_we: Input({ value: 1 }),
    byte_inc: Adder(),
    should_increment: And,
    should_reset: And,
    next_byte_counter_inc: Mux(),
    next_byte_counter: Mux(),
    byte_counter_we: Input({ value: 1 }),
    ingress_is_port0: Comparator(),
    selected_read_ptr: Mux(),
    ingress_addr_calc: Adder(),
    cross_route: Adder(),
    neg_ingress: Adder(),
    MINUS_ONE: Input({ value: 255 }),
    latch_output_port: And,
    next_output_port_val: Mux(),
    output_port_reg_we: Input({ value: 1 }),
    port_offset: LeftShifter(),
    THREE: Input({ value: 3 }),
    egress_addr_calc: Adder(),
    ingress_re_signal: Or,
    done_we: Input({ value: 1 }),
    fsm_state_display: HexDisplay,
    byte_counter_display: HexDisplay,
    output_port_debug: HexDisplay,
    ingress_port_debug: HexDisplay,
  },
  connect: ({
    inputs,
    outputs,
    nodes: {
      ...
      fsm_state_we,
      latch_ingress_port,
      next_ingress_port_val,
      ingress_port_reg_we,
      byte_inc,
      should_increment,
      should_reset,
      next_byte_counter_inc,
      next_byte_counter,
      byte_counter_we,
      ingress_is_port0,
      selected_read_ptr,
    ...
    byte_counter.q.to(
      byte_is_seven.a,
      byte_inc.a,
      next_byte_counter_inc.in0,
      ingress_addr_calc.b,
      egress_addr_calc.b,
      byte_counter_display.in,
    ),
    SEVEN.out.to(byte_is_seven.b),
    isCOPY_PAYLOAD.eq.to(
      copy_complete.a,
      should_increment.a,
      should_increment.b,
      ingress_re_signal.b,
    ...
    idle_to_read.out.to(
      next_state_m1.sel,
      latch_ingress_port.a,
      latch_ingress_port.b,
      should_reset.a,
      should_reset.b,
    ),
    ...
    next_state.out.to(fsm_state.data),
    fsm_state_we.out.to(fsm_state.we),
    ingress_port_reg.q.to(
      next_ingress_port_val.in0,
      ingress_is_port0.a,
      neg_ingress.a,
      outputs.ingress_port,
      ingress_port_debug.in,
    ),
    ...
    output_port_reg.q.to(
      next_output_port_val.in0,
      port_offset.value,
      outputs.output_port,
      output_port_debug.in,
    ),
...
const EgressController = circuit('EgressController', {
  ...
  nodes: {
    ...
    read_ptr: Register(),
    STATE_IDLE: Input({ value: 0 }),
    STATE_TRANSMIT: Input({ value: 1 }),
    ZERO: Input({ value: 0 }),
    ONE: Input({ value: 1 }),
    SEVEN: Input({ value: 7 }),
    EIGHT: Input({ value: 8 }),
    isIDLE: Comparator(),
    isTRANSMIT: Comparator(),
    can_start: And,
    idle_to_transmit: And,
    byte_is_seven: Comparator(),
    transmit_complete: And,
    next_state_m1: Mux(),
    next_state: Mux(),
    fsm_state_we: Input({ value: 1 }),
    byte_inc: Adder(),
...
export const MiniSwitch2Port = circuit('MiniSwitch2Port', {
  nodes: {
    ...
    parser0: MacRxParser,
    parser1: MacRxParser,
    ingress0: IngressController,
    ingress1: IngressController,
    ram_ingress0: DualPortRAM(),
    ram_ingress1: DualPortRAM(),
    arbiter: SimpleArbiter2Port,
    forwarder: PacketForwarder2Port,
    ram_egress0: DualPortRAM(),
    ram_egress1: DualPortRAM(),
    egress0: EgressController,
    egress1: EgressController,
    grant_is_port0: Comparator(),
    grant_to_port0: And,
    grant_is_port1: Comparator(),
    grant_to_port1: And,
    ingress_data_mux: Mux(),
    output_is_port0: Comparator(),
    egress0_we: And,
    output_is_port1: Comparator(),
    egress1_we: And,
    egress0_trigger: And,
    egress1_trigger: And,
    always_ready: Switch,
    ...
    p1_sof: Led,
    p1_eof: Led,
    debug_grant_port: HexDisplay,
    debug_grant_valid: Led,
    debug_forwarder_ingress_port: HexDisplay,
    debug_forwarder_output_port: HexDisplay,
    debug_ingress0_ready: Led,
    debug_ingress1_ready: Led,
  },
  connect: ({
    nodes: {
      p0_byte,
      ...
      debug_grant_port,
      debug_grant_valid,
      debug_forwarder_ingress_port,
      debug_forwarder_output_port,
      debug_ingress0_ready,
      debug_ingress1_ready,
    },
  }) => [
    ...
    arbiter.grant_port.to(
      forwarder.grant_port,
      grant_is_port0.a,
      grant_is_port1.a,
      debug_grant_port.in,
    ),
    arbiter.grant_valid.to(
      forwarder.grant_valid,
      grant_to_port0.a,
      grant_to_port1.a,
      debug_grant_valid.in,
    ),
    ZERO.out.to(
      grant_is_port0.b,
      forwarder.port0_read_ptr,
      forwarder.port1_read_ptr,
      output_is_port0.b,
    ),
