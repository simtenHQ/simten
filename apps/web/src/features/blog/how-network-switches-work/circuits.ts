...
const FrameDetector = circuit('FrameDetector', {
  nodes: { byteIn: Input({ value: 85 }), valid: Switch(), state: Register({ value: 0 }), PREAMBLE: Constant({ value: 85 }), SFD: Constant({ value: 213 }), zero: Constant({ value: 0 }), one: Constant({ value: 1 }), two: Constant({ value: 2 }), isPreamble: Comparator(), isSFD: Comparator(), isIdle: Comparator(), isWaiting: Comparator(), isActive: Comparator(), gotPreamble: And, gotPreambleValid: And, gotSFD: And, gotSFDValid: And, next1: Mux(), next2: Mux(), we: Input({ value: 1 }), stateDisplay: HexDisplay, frameLed: Led },
  connect: ({ nodes: { byteIn, valid, state, PREAMBLE, SFD, zero, one, two, isPreamble, isSFD, isIdle, isWaiting, isActive, gotPreamble, gotPreambleValid, gotSFD, gotSFDValid, next1, next2, we, stateDisplay, frameLed } }) => [
...
const PacketBuffer = circuit('PacketBuffer', {
  nodes: { dataIn: Input({ value: 42 }), writeCmd: Switch(), writePtr: Register({ value: 0 }), one: Constant({ value: 1 }), ram: DualPortRAM(), nextPtr: Adder(), readAddr: Input({ value: 0 }), readback: HexDisplay, ptrDisplay: HexDisplay },
  connect: ({ nodes: { dataIn, writeCmd, writePtr, one, ram, nextPtr, readAddr, readback, ptrDisplay } }) => [
...
const PortArbiter = circuit('PortArbiter', {
  nodes: { port0_ready: Switch(), port1_ready: Switch(), lastPort: Input({ value: 0 }), zero: Constant({ value: 0 }), one: Constant({ value: 1 }), lastWas0: Comparator(), prefer1: And, notPort1: Not, fallback0: And, fallback0Ready: And, lastWas1: Comparator(), prefer0: And, grant0: Or, grant1: Or, grantValid: Or, grantPort: Mux(), portDisplay: HexDisplay, validLed: Led },
  connect: ({ nodes: { port0_ready, port1_ready, lastPort, zero, one, lastWas0, prefer1, notPort1, fallback0, fallback0Ready, lastWas1, prefer0, grant0, grant1, grantValid, grantPort, portDisplay, validLed } }) => [
...
const CrossbarRouter = circuit('CrossbarRouter', {
  nodes: { sourcePort: Input({ value: 0 }), zero: Constant({ value: 0 }), one: Constant({ value: 1 }), isPort0: Comparator(), destPort: Mux(), destDisplay: HexDisplay, srcDisplay: HexDisplay, routedLed: Led },
  connect: ({ nodes: { sourcePort, zero, one, isPort0, destPort, destDisplay, srcDisplay, routedLed } }) => [
...
const PacketSerializer = circuit('PacketSerializer', {
  nodes: { ram: DualPortRAM(), readPtr: Register({ value: 0 }), one: Constant({ value: 1 }), seven: Constant({ value: 7 }), nextPtr: Adder(), enable: Switch(), dataOut: HexDisplay, ptrDisplay: HexDisplay, isDone: Comparator(), doneLed: Led },
  connect: ({ nodes: { ram, readPtr, one, seven, nextPtr, enable, dataOut, ptrDisplay, isDone, doneLed } }) => [
...
const MacRxParser = circuit('MacRxParser', {
  inputs: { byte_in: bus(8), valid: bit },
  outputs: { data_out: bus(8), sof: bit, eof: bit, data_valid: bit, error: bit },
  nodes: { fsm_state: Register(), preamble_count: Register(), byte_count: Register(), STATE_IDLE: Input({ value: 0 }), STATE_PREAMBLE_SYNC: Input({ value: 1 }), STATE_WAIT_SFD: Input({ value: 2 }), STATE_IN_FRAME: Input({ value: 3 }), PREAMBLE_BYTE: Input({ value: 85 }), SFD_BYTE: Input({ value: 213 }), SEVEN: Input({ value: 7 }), EIGHT: Input({ value: 8 }), ZERO: Input({ value: 0 }), ONE: Input({ value: 1 }), SIX: Input({ value: 6 }), isIDLE: Comparator(), isPREAMBLE_SYNC: Comparator(), isWAIT_SFD: Comparator(), isIN_FRAME: Comparator(), isPreambleByte: Comparator(), isSFDByte: Comparator(), preamble_inc: Adder(), preamble_is_seven: Comparator(), byte_inc: Adder(), byte_is_seven: Comparator(), byte_is_zero: Comparator(), idle_to_preamble: And, idle_transition: And, preamble_count_full: And, preamble_to_wait: And, preamble_to_wait_match: And, not_preamble_byte: Not, preamble_incomplete: Comparator(), preamble_bad_byte: And, preamble_broken: And, preamble_reset: And, preamble_got_sfd: And, preamble_complete: And, preamble_to_frame: And, sfd_to_frame: And, sfd_transition: And, sfd_missing: And, not_sfd_byte: Not, sfd_error: And, frame_complete: And, frame_done: And, next_state_m5: Mux(), next_state_m4: Mux(), next_state_m3: Mux(), next_state_m2: Mux(), next_state_m1: Mux(), error_reset: Or, next_state: Mux(), fsm_state_we: Input({ value: 1 }), preamble_counting: And, next_preamble_count: Mux(), preamble_count_we: Input({ value: 1 }), byte_counting: And, next_byte_count: Mux(), byte_count_we: Input({ value: 1 }), sof_condition: And, data_valid_signal: And, fsm_state_display: HexDisplay, preamble_count_display: HexDisplay, byte_count_display: HexDisplay },
  connect: ({ inputs, outputs, nodes: { fsm_state, preamble_count, byte_count, STATE_IDLE, STATE_PREAMBLE_SYNC, STATE_WAIT_SFD, STATE_IN_FRAME, PREAMBLE_BYTE, SFD_BYTE, SEVEN, ZERO, ONE, SIX, isIDLE, isPREAMBLE_SYNC, isWAIT_SFD, isIN_FRAME, isPreambleByte, isSFDByte, preamble_inc, preamble_is_seven, byte_inc, byte_is_seven, byte_is_zero, idle_to_preamble, idle_transition, preamble_count_full, preamble_to_wait, preamble_to_wait_match, not_preamble_byte, preamble_incomplete, preamble_bad_byte, preamble_broken, preamble_reset, preamble_got_sfd, preamble_complete, preamble_to_frame, sfd_to_frame, sfd_transition, sfd_missing, not_sfd_byte, sfd_error, frame_complete, frame_done, next_state_m5, next_state_m4, next_state_m3, next_state_m2, next_state_m1, error_reset, next_state, fsm_state_we, preamble_counting, next_preamble_count, preamble_count_we, byte_counting, next_byte_count, byte_count_we, sof_condition, data_valid_signal, fsm_state_display, preamble_count_display, byte_count_display } }) => [
    ...
    inputs.byte_in.to(isPreambleByte.a, isSFDByte.a, outputs.data_out),
    ...
    inputs.valid.to(idle_to_preamble.a, preamble_to_wait_match.b, preamble_reset.b, preamble_to_frame.b, sfd_transition.b, sfd_error.b, frame_done.b, preamble_counting.b, byte_counting.b, data_valid_signal.b),
    ...
    frame_complete.out.to(frame_done.a, outputs.eof),
    ...
    error_reset.out.to(next_state.sel, outputs.error),
    ...
    sof_condition.out.to(outputs.sof),
    data_valid_signal.out.to(outputs.data_valid),
  ],
});

const IngressController = circuit('IngressController', {
  inputs: { data_in: bus(8), sof: bit, eof: bit, data_valid: bit, grant: bit },
  outputs: { buf_addr: bus(8), buf_data: bus(8), buf_we: bit, pkt_ready: bit, buf_full: bit, write_ptr: bus(8) },
  nodes: { fsm_state: Register(), byte_count: Register(), write_ptr_reg: Register(), pkt_count: Register(), pkt_ready_reg: Register(), STATE_IDLE: Input({ value: 0 }), STATE_RECEIVING: Input({ value: 1 }), STATE_BUFFERED: Input({ value: 2 }), ZERO: Input({ value: 0 }), ONE: Input({ value: 1 }), FOUR: Input({ value: 4 }), SEVEN: Input({ value: 7 }), EIGHT: Input({ value: 8 }), isIDLE: Comparator(), isRECEIVING: Comparator(), isBUFFERED: Comparator(), buf_full_cmp: Comparator(), not_buf_full: Not, can_receive: And, can_receive_valid: And, idle_to_receiving: And, byte_is_seven: Comparator(), frame_complete: And, receiving_complete: And, receiving_complete_valid: And, buffered_to_idle: And, next_state_m2: Mux(), next_state_m1: Mux(), next_state: Mux(), fsm_state_we: Input({ value: 1 }), byte_inc: Adder(), should_count: And, next_byte_count: Mux(), byte_count_we: Input({ value: 1 }), ptr_add_eight: Adder(), should_advance_ptr: And, next_write_ptr_val: Mux(), write_ptr_reg_we: Input({ value: 1 }), pkt_inc: Adder(), pkt_dec: Adder(), MINUS_ONE: Input({ value: 255 }), next_pkt_count_inc: Mux(), next_pkt_count: Mux(), pkt_count_we: Input({ value: 1 }), buf_addr_calc: Adder(), buf_we_signal: And, pkt_count_nonzero: Comparator(), pkt_ready_signal: Or, pkt_ready_we: Input({ value: 1 }), fsm_state_display: HexDisplay, pkt_count_display: HexDisplay, write_ptr_debug: HexDisplay },
  connect: ({ inputs, outputs, nodes: { fsm_state, byte_count, write_ptr_reg, pkt_count, pkt_ready_reg, STATE_IDLE, STATE_RECEIVING, STATE_BUFFERED, ZERO, ONE, FOUR, SEVEN, EIGHT, isIDLE, isRECEIVING, isBUFFERED, buf_full_cmp, not_buf_full, can_receive, can_receive_valid, idle_to_receiving, byte_is_seven, frame_complete, receiving_complete, receiving_complete_valid, buffered_to_idle, next_state_m2, next_state_m1, next_state, fsm_state_we, byte_inc, should_count, next_byte_count, byte_count_we, ptr_add_eight, should_advance_ptr, next_write_ptr_val, write_ptr_reg_we, pkt_inc, pkt_dec, MINUS_ONE, next_pkt_count_inc, next_pkt_count, pkt_count_we, buf_addr_calc, buf_we_signal, pkt_count_nonzero, pkt_ready_signal, pkt_ready_we, fsm_state_display, pkt_count_display, write_ptr_debug } }) => [
    ...
    buf_full_cmp.eq.to(not_buf_full.in, outputs.buf_full),
    inputs.sof.to(can_receive.a),
    not_buf_full.out.to(can_receive.b),
    can_receive.out.to(can_receive_valid.a),
    inputs.data_valid.to(can_receive_valid.b, receiving_complete_valid.b, should_count.b, buf_we_signal.b),
    ...
    SEVEN.out.to(byte_is_seven.b),
    inputs.eof.to(frame_complete.a),
    byte_is_seven.eq.to(frame_complete.b),
    ...
    inputs.grant.to(buffered_to_idle.b),
    ...
    next_byte_count.out.to(byte_count.data),
    byte_count_we.out.to(byte_count.we),
    write_ptr_reg.q.to(ptr_add_eight.a, next_write_ptr_val.in0, buf_addr_calc.a, outputs.write_ptr, write_ptr_debug.in),
...
const SimpleArbiter2Port = circuit('SimpleArbiter2Port', {
  ...
  connect: ({ inputs, outputs, nodes: { last_port, grant_port_reg, grant_valid_reg, ZERO, ONE, last_was_port0, last_was_port1, prefer_port1, not_port1_ready, fallback_port0, fallback_port0_ready, prefer_port0, not_port0_ready, fallback_port1, fallback_port1_ready, grant_port0_signal, grant_port1_signal, grant_valid_signal, grant_port_mux, grant_valid_we, grant_port_we, next_last_port, last_port_we, last_port_display } }) => [
    ...
    inputs.port1_ready.to(prefer_port1.b, not_port1_ready.in, fallback_port1_ready.b),
    not_port1_ready.out.to(fallback_port0.b),
    fallback_port0.out.to(fallback_port0_ready.a),
    inputs.port0_ready.to(fallback_port0_ready.b, prefer_port0.b, not_port0_ready.in),
    ...
    grant_valid_reg.q.to(outputs.grant_valid),
    grant_port_reg.q.to(outputs.grant_port, next_last_port.in1),
    inputs.forwarder_done.to(next_last_port.sel),
...
const PacketForwarder2Port = circuit('PacketForwarder2Port', {
  inputs: { grant_port: bus(8), grant_valid: bit, port0_read_ptr: bus(8), port1_read_ptr: bus(8) },
  outputs: { ingress_addr: bus(8), ingress_re: bit, egress_addr: bus(8), egress_we: bit, done: bit, output_port: bus(8), ingress_port: bus(8) },
  nodes: { fsm_state: Register(), byte_counter: Register(), output_port_reg: Register(), ingress_port_reg: Register(), done_reg: Register(), STATE_IDLE: Input({ value: 0 }), STATE_READ_HEADER: Input({ value: 1 }), STATE_WAIT_HEADER: Input({ value: 2 }), STATE_ROUTE: Input({ value: 3 }), STATE_COPY_PAYLOAD: Input({ value: 4 }), STATE_DONE: Input({ value: 5 }), ZERO: Input({ value: 0 }), ONE: Input({ value: 1 }), SEVEN: Input({ value: 7 }), EIGHT: Input({ value: 8 }), DA_MASK: Input({ value: 240 }), DA_SHIFT: Input({ value: 4 }), isIDLE: Comparator(), isREAD_HEADER: Comparator(), isWAIT_HEADER: Comparator(), isROUTE: Comparator(), isCOPY_PAYLOAD: Comparator(), isDONE: Comparator(), idle_to_read: And, read_to_wait: And, wait_to_route: And, byte_is_seven: Comparator(), copy_complete: And, done_to_idle: And, next_state_m5: Mux(), next_state_m4: Mux(), next_state_m3: Mux(), next_state_m2: Mux(), next_state_m1: Mux(), route_to_copy: And, next_state: Mux(), fsm_state_we: Input({ value: 1 }), latch_ingress_port: And, next_ingress_port_val: Mux(), ingress_port_reg_we: Input({ value: 1 }), byte_inc: Adder(), should_increment: And, should_reset: And, next_byte_counter_inc: Mux(), next_byte_counter: Mux(), byte_counter_we: Input({ value: 1 }), ingress_is_port0: Comparator(), selected_read_ptr: Mux(), ingress_addr_calc: Adder(), cross_route: Adder(), neg_ingress: Adder(), MINUS_ONE: Input({ value: 255 }), latch_output_port: And, next_output_port_val: Mux(), output_port_reg_we: Input({ value: 1 }), port_offset: LeftShifter(), THREE: Input({ value: 3 }), egress_addr_calc: Adder(), ingress_re_signal: Or, done_we: Input({ value: 1 }), fsm_state_display: HexDisplay, byte_counter_display: HexDisplay, output_port_debug: HexDisplay, ingress_port_debug: HexDisplay },
  connect: ({ inputs, outputs, nodes: { fsm_state, byte_counter, output_port_reg, ingress_port_reg, done_reg, STATE_IDLE, STATE_READ_HEADER, STATE_WAIT_HEADER, STATE_ROUTE, STATE_COPY_PAYLOAD, STATE_DONE, ZERO, ONE, SEVEN, isIDLE, isREAD_HEADER, isWAIT_HEADER, isROUTE, isCOPY_PAYLOAD, isDONE, idle_to_read, read_to_wait, wait_to_route, byte_is_seven, copy_complete, done_to_idle, next_state_m5, next_state_m4, next_state_m3, next_state_m2, next_state_m1, route_to_copy, next_state, fsm_state_we, latch_ingress_port, next_ingress_port_val, ingress_port_reg_we, byte_inc, should_increment, should_reset, next_byte_counter_inc, next_byte_counter, byte_counter_we, ingress_is_port0, selected_read_ptr, ingress_addr_calc, cross_route, neg_ingress, MINUS_ONE, latch_output_port, next_output_port_val, output_port_reg_we, port_offset, THREE, egress_addr_calc, ingress_re_signal, done_we, fsm_state_display, byte_counter_display, output_port_debug, ingress_port_debug } }) => [
    ...
    inputs.grant_valid.to(idle_to_read.b),
    ...
    SEVEN.out.to(byte_is_seven.b),
    isCOPY_PAYLOAD.eq.to(copy_complete.a, should_increment.a, should_increment.b, ingress_re_signal.b, outputs.egress_we),
    ...
    next_state.out.to(fsm_state.data),
    fsm_state_we.out.to(fsm_state.we),
    ingress_port_reg.q.to(next_ingress_port_val.in0, ingress_is_port0.a, neg_ingress.a, outputs.ingress_port, ingress_port_debug.in),
    inputs.grant_port.to(next_ingress_port_val.in1),
    ...
    inputs.port1_read_ptr.to(selected_read_ptr.in0),
    inputs.port0_read_ptr.to(selected_read_ptr.in1),
    ...
    output_port_reg.q.to(next_output_port_val.in0, port_offset.value, outputs.output_port, output_port_debug.in),
    ...
    ingress_addr_calc.sum.to(outputs.ingress_addr),
    egress_addr_calc.sum.to(outputs.egress_addr),
    ingress_re_signal.out.to(outputs.ingress_re),
    done_we.out.to(done_reg.we),
    done_reg.q.to(outputs.done),
  ],
});

const EgressController = circuit('EgressController', {
  inputs: { pkt_ready: bit, trigger: bit },
  outputs: { egress_addr: bus(8), egress_re: bit, data_valid: bit, sof: bit, eof: bit, ready: bit },
  nodes: { fsm_state: Register(), byte_counter: Register(), read_ptr: Register(), STATE_IDLE: Input({ value: 0 }), STATE_TRANSMIT: Input({ value: 1 }), ZERO: Input({ value: 0 }), ONE: Input({ value: 1 }), SEVEN: Input({ value: 7 }), EIGHT: Input({ value: 8 }), isIDLE: Comparator(), isTRANSMIT: Comparator(), can_start: And, idle_to_transmit: And, byte_is_seven: Comparator(), transmit_complete: And, next_state_m1: Mux(), next_state: Mux(), fsm_state_we: Input({ value: 1 }), byte_inc: Adder(), should_increment: And, should_reset: And, next_byte_counter_inc: Mux(), next_byte_counter: Mux(), byte_counter_we: Input({ value: 1 }), ptr_add_eight: Adder(), should_advance_ptr: And, next_read_ptr: Mux(), read_ptr_we: Input({ value: 1 }), egress_addr_calc: Adder(), byte_is_zero: Comparator(), sof_signal: And, eof_signal: And, fsm_state_display: HexDisplay, byte_counter_display: HexDisplay, read_ptr_display: HexDisplay },
  connect: ({ inputs, outputs, nodes: { fsm_state, byte_counter, read_ptr, STATE_IDLE, STATE_TRANSMIT, ZERO, ONE, SEVEN, EIGHT, isIDLE, isTRANSMIT, can_start, idle_to_transmit, byte_is_seven, transmit_complete, next_state_m1, next_state, fsm_state_we, byte_inc, should_increment, should_reset, next_byte_counter_inc, next_byte_counter, byte_counter_we, ptr_add_eight, should_advance_ptr, next_read_ptr, read_ptr_we, egress_addr_calc, byte_is_zero, sof_signal, eof_signal, fsm_state_display, byte_counter_display, read_ptr_display } }) => [
    ...
    inputs.trigger.to(can_start.a),
    inputs.pkt_ready.to(can_start.b),
    isIDLE.eq.to(idle_to_transmit.a, outputs.ready),
    ...
    SEVEN.out.to(byte_is_seven.b),
    isTRANSMIT.eq.to(transmit_complete.a, should_increment.a, should_increment.b, outputs.egress_re, outputs.data_valid, sof_signal.a, eof_signal.a),
