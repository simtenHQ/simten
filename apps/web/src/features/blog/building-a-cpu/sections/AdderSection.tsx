    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          We built a full adder that adds three single bits. But a CPU needs to add <em>numbers</em>
          . The trick is <strong className="text-gray-900 dark:text-white">chaining</strong>:
          connect the carry-out of each full adder to the carry-in of the next. Four full adders in
          a row give you a 4-bit adder that can add numbers 0&ndash;15.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          This is called a{' '}
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <strong>B</strong> switches to 0101 (5). You should see the sum LEDs show 1000 (8).
        </p>
      </div>
