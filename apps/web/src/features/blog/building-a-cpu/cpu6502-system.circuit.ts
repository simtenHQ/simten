...
const ROM16K = circuit('ROM16K', {
  ...
  nodes: {
    c0: Constant({ value: 192 }),
    f0: Constant({ value: 240 }),
    addr_hi_cmp: Comparator(),
    io_cmp: Comparator(),
    ge_c0: Not,
    not_io: Not,
    rom_responds: And,
    addr_combine: AddressCombiner,
  },
  connect: ({
    inputs,
    outputs,
    nodes: { c0, f0, addr_hi_cmp, io_cmp, ge_c0, not_io, rom_responds, addr_combine },
  }) => [
...
const ConsoleOutput = circuit('ConsoleOutput', {
  ...
  connect: ({
    inputs,
    outputs,
    nodes: { f0, zero, hi_match, lo_match, addr_match, console_we, console },
  }) => [
...
export const MemoryBusTest = circuit('MemoryBusTest', {
  nodes: {
    rom: ROM({ baseAddress: 49152, memory: { '49152': 171, '65533': 192 } }),
    mem_bus: MemoryBus,
    addr_lo_in: Input(),
    addr_hi_in: Input(),
    data_in: Input(),
    rw_in: Input(),
    d_data_out: HexDisplay,
  },
...
const StackPointer = circuit('StackPointer', {
  ...
  outputs: { sp: bus(8) },
  nodes: {
    sp_reg: Register({ value: 255 }),
    always_on: Constant({ value: 1 }),
    one: Constant({ value: 1 }),
    dec: Subtractor(),
    zero_bit: Constant({ value: 0 }),
    inc: Adder(),
    mux_inc: Mux(),
    mux_dec: Mux(),
    mux_load: Mux(),
  ...
  connect: ({
    inputs,
    outputs,
    nodes: { sp_reg, always_on, one, dec, zero_bit, inc, mux_inc, mux_dec, mux_load },
  }) => [
...
const FlagRegister = circuit('FlagRegister', {
  ...
  nodes: {
    reg_n: Register({ value: 0 }),
    reg_z: Register({ value: 0 }),
    reg_c: Register({ value: 0 }),
    reg_v: Register({ value: 0 }),
    reg_d: Register({ value: 0 }),
    reg_i: Register({ value: 0 }),
  },
...
const ControlFSM = circuit('ControlFSM', {
  ...
  nodes: {
    state_reg: Register({ value: 253 }),
    subcycle_reg: Register(),
    STATE_FETCH: Constant({ value: 0 }),
    STATE_DECODE: Constant({ value: 1 }),
    STATE_EXECUTE: Constant({ value: 2 }),
    STATE_RESET_LO: Constant({ value: 253 }),
    STATE_RESET_HI: Constant({ value: 254 }),
    is_fetch: Comparator(),
    is_decode: Comparator(),
    is_execute: Comparator(),
    is_reset_lo_cmp: Comparator(),
    is_reset_hi_cmp: Comparator(),
    LDA_IMM: Constant({ value: 169 }),
    LDA_ZP: Constant({ value: 165 }),
    LDA_ABS: Constant({ value: 173 }),
    LDA_ABS_X: Constant({ value: 189 }),
    STA_ZP: Constant({ value: 133 }),
    STA_ABS: Constant({ value: 141 }),
    STA_ABS_X: Constant({ value: 157 }),
    TAX: Constant({ value: 170 }),
    INX: Constant({ value: 232 }),
    PHA: Constant({ value: 72 }),
    PLA: Constant({ value: 104 }),
    JSR: Constant({ value: 32 }),
    RTS: Constant({ value: 96 }),
    JMP_ABS: Constant({ value: 76 }),
    CMP_IMM: Constant({ value: 201 }),
    BEQ: Constant({ value: 240 }),
    BNE: Constant({ value: 208 }),
    BCC: Constant({ value: 144 }),
    BCS: Constant({ value: 176 }),
    BMI: Constant({ value: 48 }),
    BPL: Constant({ value: 16 }),
    BVC: Constant({ value: 80 }),
    BVS: Constant({ value: 112 }),
    SEC: Constant({ value: 56 }),
    CLC: Constant({ value: 24 }),
    NOP: Constant({ value: 234 }),
    AND_IMM: Constant({ value: 41 }),
    ORA_IMM: Constant({ value: 9 }),
    EOR_IMM: Constant({ value: 73 }),
    INY: Constant({ value: 200 }),
    DEX: Constant({ value: 202 }),
    DEY: Constant({ value: 136 }),
    TXA: Constant({ value: 138 }),
    TYA: Constant({ value: 152 }),
    LDY_IMM: Constant({ value: 160 }),
    CPX_IMM: Constant({ value: 224 }),
    CPY_IMM: Constant({ value: 192 }),
    TXS: Constant({ value: 154 }),
    TSX: Constant({ value: 186 }),
    CLV: Constant({ value: 184 }),
    LDX_IMM: Constant({ value: 162 }),
    SBC_IMM: Constant({ value: 233 }),
    ADC_IMM: Constant({ value: 105 }),
    STX_ZP: Constant({ value: 134 }),
    STY_ZP: Constant({ value: 132 }),
    ASL_A: Constant({ value: 10 }),
    LSR_A: Constant({ value: 74 }),
    ROL_A: Constant({ value: 42 }),
    ROR_A: Constant({ value: 106 }),
    SEI: Constant({ value: 120 }),
    CLI: Constant({ value: 88 }),
    SED: Constant({ value: 248 }),
    CLD: Constant({ value: 216 }),
    INC_ZP: Constant({ value: 230 }),
    DEC_ZP: Constant({ value: 198 }),
    ASL_ZP: Constant({ value: 6 }),
    LSR_ZP: Constant({ value: 70 }),
    ROL_ZP: Constant({ value: 38 }),
    ROR_ZP: Constant({ value: 102 }),
    LDA_ZP_X: Constant({ value: 181 }),
    STA_ZP_X: Constant({ value: 149 }),
    ADC_ZP_X: Constant({ value: 117 }),
    SBC_ZP_X: Constant({ value: 245 }),
    AND_ZP_X: Constant({ value: 53 }),
    ORA_ZP_X: Constant({ value: 21 }),
    EOR_ZP_X: Constant({ value: 85 }),
    CMP_ZP_X: Constant({ value: 213 }),
    LDX_ZP_Y: Constant({ value: 182 }),
    STX_ZP_Y: Constant({ value: 150 }),
    LDA_ABS_Y: Constant({ value: 185 }),
    STA_ABS_Y: Constant({ value: 153 }),
    ADC_ABS_Y: Constant({ value: 121 }),
    SBC_ABS_Y: Constant({ value: 249 }),
    AND_ABS_Y: Constant({ value: 57 }),
    ORA_ABS_Y: Constant({ value: 25 }),
    EOR_ABS_Y: Constant({ value: 89 }),
    CMP_ABS_Y: Constant({ value: 217 }),
    LDX_ABS_Y: Constant({ value: 190 }),
    LDA_IND_X: Constant({ value: 161 }),
    STA_IND_X: Constant({ value: 129 }),
    ADC_IND_X: Constant({ value: 97 }),
    SBC_IND_X: Constant({ value: 225 }),
    AND_IND_X: Constant({ value: 33 }),
    ORA_IND_X: Constant({ value: 1 }),
    EOR_IND_X: Constant({ value: 65 }),
    CMP_IND_X: Constant({ value: 193 }),
    LDA_IND_Y: Constant({ value: 177 }),
    STA_IND_Y: Constant({ value: 145 }),
    ADC_IND_Y: Constant({ value: 113 }),
    SBC_IND_Y: Constant({ value: 241 }),
    AND_IND_Y: Constant({ value: 49 }),
    ORA_IND_Y: Constant({ value: 17 }),
    EOR_IND_Y: Constant({ value: 81 }),
    CMP_IND_Y: Constant({ value: 209 }),
    BIT_ZP: Constant({ value: 36 }),
    BIT_ABS: Constant({ value: 44 }),
    PHP: Constant({ value: 8 }),
    PLP: Constant({ value: 40 }),
    JMP_IND: Constant({ value: 108 }),
    RTI: Constant({ value: 64 }),
    ASL_ZP_X: Constant({ value: 22 }),
    LSR_ZP_X: Constant({ value: 86 }),
    ROL_ZP_X: Constant({ value: 54 }),
    ROR_ZP_X: Constant({ value: 118 }),
    ASL_ABS: Constant({ value: 14 }),
    LSR_ABS: Constant({ value: 78 }),
    ROL_ABS: Constant({ value: 46 }),
    ROR_ABS: Constant({ value: 110 }),
    ASL_ABS_X: Constant({ value: 30 }),
    LSR_ABS_X: Constant({ value: 94 }),
    ROL_ABS_X: Constant({ value: 62 }),
    ROR_ABS_X: Constant({ value: 126 }),
    INC_ZP_X: Constant({ value: 246 }),
    DEC_ZP_X: Constant({ value: 214 }),
    INC_ABS: Constant({ value: 238 }),
    DEC_ABS: Constant({ value: 206 }),
    INC_ABS_X: Constant({ value: 254 }),
    DEC_ABS_X: Constant({ value: 222 }),
    CPX_ZP: Constant({ value: 228 }),
    CPY_ZP: Constant({ value: 196 }),
    CPX_ABS: Constant({ value: 236 }),
    CPY_ABS: Constant({ value: 204 }),
    LDX_ZP: Constant({ value: 166 }),
    LDX_ABS: Constant({ value: 174 }),
    LDY_ZP: Constant({ value: 164 }),
    LDY_ZP_X: Constant({ value: 180 }),
    LDY_ABS: Constant({ value: 172 }),
    LDY_ABS_X: Constant({ value: 188 }),
    STX_ABS: Constant({ value: 142 }),
    STY_ZP_X: Constant({ value: 148 }),
    STY_ABS: Constant({ value: 140 }),
    cmp_lda_imm: Comparator(),
    cmp_lda_zp: Comparator(),
    cmp_lda_abs: Comparator(),
    cmp_lda_abs_x: Comparator(),
    cmp_sta_zp: Comparator(),
    cmp_sta_abs: Comparator(),
    cmp_sta_abs_x: Comparator(),
    cmp_tax: Comparator(),
    cmp_inx: Comparator(),
    cmp_pha: Comparator(),
    cmp_pla: Comparator(),
    cmp_jsr: Comparator(),
    cmp_rts: Comparator(),
    cmp_jmp_abs: Comparator(),
    cmp_cmp_imm: Comparator(),
    cmp_beq: Comparator(),
    cmp_bne: Comparator(),
    cmp_bcc: Comparator(),
    cmp_bcs: Comparator(),
    ...
    cmp_clc: Comparator(),
    cmp_nop: Comparator(),
    cmp_and_imm: Comparator(),
    cmp_ora_imm: Comparator(),
    cmp_eor_imm: Comparator(),
    cmp_iny: Comparator(),
    cmp_dex: Comparator(),
    cmp_dey: Comparator(),
    cmp_txa: Comparator(),
    cmp_tya: Comparator(),
    cmp_ldy_imm: Comparator(),
    cmp_cpx_imm: Comparator(),
    cmp_cpy_imm: Comparator(),
    cmp_txs: Comparator(),
    cmp_tsx: Comparator(),
    cmp_clv: Comparator(),
    cmp_ldx_imm: Comparator(),
    cmp_sbc_imm: Comparator(),
    cmp_adc_imm: Comparator(),
    cmp_stx_zp: Comparator(),
    cmp_sty_zp: Comparator(),
    cmp_asl_a: Comparator(),
    cmp_lsr_a: Comparator(),
    cmp_rol_a: Comparator(),
    cmp_ror_a: Comparator(),
    cmp_sei: Comparator(),
    cmp_cli: Comparator(),
    cmp_sed: Comparator(),
    cmp_cld: Comparator(),
    cmp_inc_zp: Comparator(),
    cmp_dec_zp: Comparator(),
    cmp_asl_zp: Comparator(),
    cmp_lsr_zp: Comparator(),
    cmp_rol_zp: Comparator(),
    cmp_ror_zp: Comparator(),
    cmp_lda_zp_x: Comparator(),
    cmp_sta_zp_x: Comparator(),
    cmp_adc_zp_x: Comparator(),
    cmp_sbc_zp_x: Comparator(),
    cmp_and_zp_x: Comparator(),
    cmp_ora_zp_x: Comparator(),
    cmp_eor_zp_x: Comparator(),
    cmp_cmp_zp_x: Comparator(),
    is_zp_x_1: Or,
    is_zp_x_2: Or,
    is_zp_x_3: Or,
    is_zp_x_4: Or,
    ...
    is_zp_x_10: Or,
    is_zp_x_final: Or,
    cmp_ldx_zp_y: Comparator(),
    cmp_stx_zp_y: Comparator(),
    is_zp_y_final: Or,
    cmp_lda_abs_y: Comparator(),
    cmp_sta_abs_y: Comparator(),
    cmp_adc_abs_y: Comparator(),
    cmp_sbc_abs_y: Comparator(),
    cmp_and_abs_y: Comparator(),
    cmp_ora_abs_y: Comparator(),
    cmp_eor_abs_y: Comparator(),
    cmp_cmp_abs_y: Comparator(),
    cmp_ldx_abs_y: Comparator(),
    is_abs_y_1: Or,
    is_abs_y_2: Or,
    is_abs_y_3: Or,
    is_abs_y_4: Or,
    ...
    is_abs_y_7: Or,
    is_abs_y_final: Or,
    cmp_lda_ind_x: Comparator(),
    cmp_sta_ind_x: Comparator(),
    cmp_adc_ind_x: Comparator(),
    cmp_sbc_ind_x: Comparator(),
    cmp_and_ind_x: Comparator(),
    cmp_ora_ind_x: Comparator(),
    cmp_eor_ind_x: Comparator(),
    cmp_cmp_ind_x: Comparator(),
    is_ind_x_1: Or,
    is_ind_x_2: Or,
    is_ind_x_3: Or,
    is_ind_x_4: Or,
    ...
    is_ind_x_6: Or,
    is_ind_x_final: Or,
    cmp_lda_ind_y: Comparator(),
    cmp_sta_ind_y: Comparator(),
    cmp_adc_ind_y: Comparator(),
    cmp_sbc_ind_y: Comparator(),
    cmp_and_ind_y: Comparator(),
    cmp_ora_ind_y: Comparator(),
    cmp_eor_ind_y: Comparator(),
    cmp_cmp_ind_y: Comparator(),
    is_ind_y_1: Or,
    is_ind_y_2: Or,
    is_ind_y_3: Or,
    is_ind_y_4: Or,
    ...
    is_ind_y_6: Or,
    is_ind_y_final: Or,
    cmp_bit_zp: Comparator(),
    cmp_bit_abs: Comparator(),
    cmp_php: Comparator(),
    cmp_plp: Comparator(),
    cmp_jmp_ind: Comparator(),
    cmp_rti: Comparator(),
    cmp_asl_zp_x: Comparator(),
    cmp_lsr_zp_x: Comparator(),
    cmp_rol_zp_x: Comparator(),
    cmp_ror_zp_x: Comparator(),
    cmp_asl_abs: Comparator(),
    cmp_lsr_abs: Comparator(),
    cmp_rol_abs: Comparator(),
    cmp_ror_abs: Comparator(),
    cmp_asl_abs_x: Comparator(),
    cmp_lsr_abs_x: Comparator(),
    cmp_rol_abs_x: Comparator(),
    cmp_ror_abs_x: Comparator(),
    is_shift_zp_x_temp: Or,
    is_shift_zp_x_temp2: Or,
    is_shift_zp_x_signal: Or,
    is_shift_abs_temp: Or,
    is_shift_abs_temp2: Or,
    is_shift_abs_signal: Or,
    is_shift_abs_x_temp: Or,
    is_shift_abs_x_temp2: Or,
    is_shift_abs_x_signal: Or,
    cmp_inc_zp_x: Comparator(),
    cmp_dec_zp_x: Comparator(),
    cmp_inc_abs: Comparator(),
    cmp_dec_abs: Comparator(),
    cmp_inc_abs_x: Comparator(),
    cmp_dec_abs_x: Comparator(),
    is_inc_dec_zp_x_signal: Or,
    is_inc_dec_abs_signal: Or,
    is_inc_dec_abs_x_signal: Or,
    cmp_cpx_zp: Comparator(),
    cmp_cpy_zp: Comparator(),
    cmp_cpx_abs: Comparator(),
    cmp_cpy_abs: Comparator(),
    cmp_ldx_zp: Comparator(),
    cmp_ldx_abs: Comparator(),
    cmp_ldy_zp: Comparator(),
    cmp_ldy_zp_x: Comparator(),
    cmp_ldy_abs: Comparator(),
    cmp_ldy_abs_x: Comparator(),
    cmp_stx_abs: Comparator(),
    cmp_sty_zp_x: Comparator(),
    cmp_sty_abs: Comparator(),
    is_rmw_inc_dec_zp: Or,
    is_rmw_inc_dec_temp: Or,
    is_rmw_inc_dec_temp2: Or,
    is_rmw_inc_dec: Or,
    is_rmw_asl_lsr: Or,
    is_rmw_rol_ror: Or,
    is_rmw_shift_zp: Or,
    is_rmw_shift_temp: Or,
    is_rmw_shift_temp2: Or,
    is_rmw_shift: Or,
    is_rmw: Or,
    is_imm_lda: Or,
    is_imm_lda_2: Or,
    ...
    four: Constant({ value: 4 }),
    five: Constant({ value: 5 }),
    inc_subcycle: Incrementer,
    subcycle_increment: Mux(),
    always_on: Constant({ value: 1 }),
    is_sub0: Comparator(),
    is_sub1: Comparator(),
    is_sub2: Comparator(),
    ...
    exec_done_temp15: Or,
    exec_done: Or,
    next_from_execute: Mux(),
    next_from_reset_lo: Mux(),
    next_from_reset_hi: Mux(),
    in_reset_state: Or,
    reset_not_in_reset: And,
    not_in_reset: Not,
    next_state: Mux(),
    needs_operand_any: Or,
    needs_operand_temp: Or,
    needs_operand_temp2: Or,
    needs_operand_temp3: Or,
    needs_operand_temp4: Or,
    needs_operand_temp5: Or,
    needs_operand_temp6: Or,
    needs_operand: Or,
    pc_inc_exec_sub0: And,
    needs_2nd_byte_temp: Or,
    needs_2nd_byte_temp2: Or,
    needs_2nd_byte: Or,
    pc_inc_exec_sub1: And,
    pc_inc_temp: Or,
    pc_inc_signal: Or,
    operand_load_signal: And,
    addr_lo_load_signal: And,
    addr_hi_load_signal: And,
    is_load: Or,
    is_load_final: Or,
    mem_read_zp: And,
    is_zp_x_load: And,
    ...
    mem_read_abs: Or,
    mem_read_rmw: And,
    mem_read_signal_temp1: Or,
    mem_read_signal_temp1b: Or,
    mem_read_signal_temp2: Or,
    mem_read_signal: Or,
    is_store_zp_1: Or,
    is_store_zp_2: Or,
    is_store_zp_3: Or,
    ...
    mem_write_zp: And,
    is_stx_any: Or,
    use_x_for_mem_signal: And,
    use_y_for_mem_signal: And,
    mem_write_abs_temp: And,
    mem_write_abs_x: And,
    mem_write_abs_y: And,
    mem_write_abs_1: Or,
    mem_write_abs: Or,
    ...
    mem_write_ind_x: And,
    mem_write_ind_y: And,
    mem_write_signal_temp: Or,
    mem_write_signal_temp2: Or,
    mem_write_signal_temp3: Or,
    mem_write_signal: Or,
    sp_dec_pha: And,
    sp_dec_jsr_sub2: And,
    sp_dec_jsr_sub3: And,
    ...
    stack_write_pha: And,
    stack_write_php: And,
    stack_write_jsr_hi: And,
    stack_write_jsr_lo: And,
    stack_write_temp: Or,
    stack_write_temp2: Or,
    stack_write_signal: Or,
    use_stack_pla: And,
    use_stack_plp: And,
    use_stack_rts_lo: And,
    use_stack_rts_hi: And,
    use_stack_rti_flags: And,
    use_stack_rti_lo: And,
    use_stack_rti_hi: And,
    use_stack_temp1: Or,
    use_stack_temp2: Or,
    use_stack_temp3: Or,
    use_stack_temp4: Or,
    use_stack_temp5: Or,
    use_stack_signal: Or,
    update_flags_plp_signal: And,
    jmp_abs_load_pc_signal: And,
    jsr_load_pc_signal: And,
    rts_load_pc_signal: And,
    jmp_ind_load_pc_signal: And,
    rti_load_pc_signal: And,
    rti_pull_p_signal: And,
    update_flags_rti_signal: And,
    push_pc_hi_signal: And,
    push_pc_lo_signal: And,
    pull_pc_lo_rts: And,
    pull_pc_lo_rti: And,
    pull_pc_lo_signal: Or,
    pull_pc_hi_rts: And,
    pull_pc_hi_rti: And,
    pull_pc_hi_signal: Or,
    branch_at_sub1: And,
    update_flags_lda: And,
    is_any_compare: Or,
    is_any_compare_2: Or,
    update_flags_cmp: And,
    is_zp_x_flags_1: Or,
    is_zp_x_flags_2: Or,
    is_zp_x_flags_3: Or,
    is_zp_x_flags_4: Or,
    ...
    is_ind_y_flags_5: Or,
    is_ind_y_flags: Or,
    update_flags_ind_y: And,
    update_flags_ldy: And,
    update_flags_ldx: And,
    is_reg_inc_dec: Or,
    is_reg_inc_dec_2: Or,
    is_reg_inc_dec_3: Or,
    is_reg_inc_dec_4: Or,
    ...
    is_reg_inc_dec_8: Or,
    is_reg_inc_dec_9: Or,
    is_reg_inc_dec_10: Or,
    update_flags_inx: And,
    update_flags_temp: Or,
    update_flags_temp2: Or,
    update_flags_temp3: Or,
    update_flags_rmw: And,
    update_flags_temp4: Or,
    update_flags_temp5: Or,
    update_flags_temp6: Or,
    update_flags_temp7: Or,
    update_flags_temp8: Or,
    update_flags_temp9: Or,
    update_flags_bit_zp: And,
    update_flags_bit_abs: And,
    update_flags_bit: Or,
    update_flags_signal: Or,
    is_sec_clc: Or,
    update_c_only_signal: And,
    set_c_signal: And,
    clear_c_signal: And,
    clear_v_signal: And,
    set_d_signal: And,
    ...
    update_i_signal: Or,
    sp_load_signal: And,
    ptr_lo_load_ind_x: And,
    ptr_lo_load_ind_y: And,
    ptr_lo_load_temp: Or,
    ptr_lo_load_jmp_ind: And,
    ptr_lo_load_signal: Or,
    ptr_hi_load_ind_x: And,
    ptr_hi_load_ind_y: And,
    ptr_hi_load_temp: Or,
    ptr_hi_load_jmp_ind: And,
    ptr_hi_load_signal: Or,
    ind_x_sub3_signal: And,
    ind_x_sub4_signal: And,
    ind_x_sub5_signal: And,
    ind_y_sub2_signal: And,
    ind_y_sub3_signal: And,
    ind_y_sub4_signal: And,
    ind_y_sub5_signal: And,
    jmp_ind_sub2_signal: And,
    jmp_ind_sub3_signal: And,
    write_a_imm: And,
    write_a_zp: And,
    is_zp_x_write_a_1: Or,
    is_zp_x_write_a_2: Or,
    is_zp_x_write_a_3: Or,
    is_zp_x_write_a_4: Or,
    is_zp_x_write_a: Or,
    write_a_zp_x: And,
    write_a_abs_temp: And,
    write_a_abs_x: And,
    is_abs_y_write_a_1: Or,
    is_abs_y_write_a_2: Or,
    is_abs_y_write_a_3: Or,
    is_abs_y_write_a_4: Or,
    is_abs_y_write_a: Or,
    write_a_abs_y: And,
    is_ind_x_write_a_1: Or,
    is_ind_x_write_a_2: Or,
    is_ind_x_write_a_3: Or,
    is_ind_x_write_a_4: Or,
    is_ind_x_write_a: Or,
    write_a_ind_x: And,
    is_ind_y_write_a_1: Or,
    is_ind_y_write_a_2: Or,
    is_ind_y_write_a_3: Or,
    is_ind_y_write_a_4: Or,
    is_ind_y_write_a: Or,
    write_a_ind_y: And,
    write_a_abs_temp2: Or,
    write_a_abs: Or,
    write_a_zp_all: Or,
    write_a_temp: Or,
    write_a_temp2: Or,
    ...
    write_a_temp5: Or,
    is_shift_rotate: Or,
    is_shift_rotate_2: Or,
    is_shift_rotate_all: Or,
    write_a_shift: And,
    write_a_temp6: Or,
    write_a_temp7: Or,
    write_a_signal: Or,
    ...
    write_x_tsx: And,
    write_x_ldx_imm: And,
    write_x_ldx_zp_y: And,
    write_x_ldx_abs_y: And,
    write_x_temp: Or,
    write_x_temp2: Or,
    write_x_temp3: Or,
    write_x_temp4: Or,
  ...
  connect: ({
    ...
    nodes: {
      ...
      is_shift_zp_x_temp,
      is_shift_zp_x_temp2,
      is_shift_zp_x_signal,
      is_shift_abs_temp,
      is_shift_abs_temp2,
      is_shift_abs_signal,
      is_shift_abs_x_temp,
      is_shift_abs_x_temp2,
      is_shift_abs_x_signal,
      cmp_inc_zp_x,
      cmp_dec_zp_x,
      cmp_inc_abs,
      cmp_dec_abs,
      cmp_inc_abs_x,
      cmp_dec_abs_x,
      is_inc_dec_zp_x_signal,
      is_inc_dec_abs_signal,
      is_inc_dec_abs_x_signal,
      cmp_cpx_zp,
      cmp_cpy_zp,
      cmp_cpx_abs,
      cmp_cpy_abs,
      ...
      mem_read_abs,
      mem_read_rmw,
      mem_read_signal_temp1,
      mem_read_signal_temp1b,
      mem_read_signal_temp2,
      mem_read_signal,
      is_store_zp_1,
      is_store_zp_2,
      is_store_zp_3,
      ...
      mem_write_zp,
      is_stx_any,
      use_x_for_mem_signal,
      use_y_for_mem_signal,
      mem_write_abs_temp,
      mem_write_abs_x,
      mem_write_abs_y,
      mem_write_abs_1,
      ...
      mem_write_ind_x,
      mem_write_ind_y,
      mem_write_signal_temp,
      mem_write_signal_temp2,
      mem_write_signal_temp3,
      mem_write_signal,
      sp_dec_pha,
      sp_dec_jsr_sub2,
      sp_dec_jsr_sub3,
      ...
      use_stack_temp5,
      use_stack_signal,
      update_flags_plp_signal,
      jmp_abs_load_pc_signal,
      jsr_load_pc_signal,
      rts_load_pc_signal,
      jmp_ind_load_pc_signal,
      rti_load_pc_signal,
      rti_pull_p_signal,
      update_flags_rti_signal,
      push_pc_hi_signal,
      push_pc_lo_signal,
      pull_pc_lo_rts,
      pull_pc_lo_rti,
      ...
      update_flags_temp9,
      update_flags_bit_zp,
      update_flags_bit_abs,
      update_flags_bit,
      update_flags_signal,
      is_sec_clc,
      update_c_only_signal,
      set_c_signal,
      clear_c_signal,
      clear_v_signal,
      set_d_signal,
    ...
    cmp_jsr.eq.to(
      outputs.is_jsr,
      done_jsr.b,
      needs_operand_temp2.b,
      needs_2nd_byte_temp.b,
      sp_dec_jsr_sub2.b,
      sp_dec_jsr_sub3.b,
      stack_write_jsr_hi.b,
      stack_write_jsr_lo.b,
      jsr_load_pc_signal.b,
      push_pc_hi_signal.b,
      push_pc_lo_signal.b,
    ),
    ...
    cmp_jmp_abs.eq.to(
      outputs.is_jmp_abs,
      done_jmp_abs.b,
      needs_operand_temp6.b,
      needs_2nd_byte_temp2.b,
      jmp_abs_load_pc_signal.b,
    ),
    ...
    cmp_lda_abs_y.eq.to(
      outputs.is_lda_abs_y,
      is_abs_y_1.a,
      is_abs_y_flags_1.a,
      is_abs_y_write_a_1.a,
    ),
    ...
    cmp_adc_abs_y.eq.to(
      outputs.is_adc_abs_y,
      is_abs_y_2.b,
      is_abs_y_flags_1.b,
      is_abs_y_write_a_1.b,
    ),
    SBC_ABS_Y.out.to(cmp_sbc_abs_y.b),
    cmp_sbc_abs_y.eq.to(
      outputs.is_sbc_abs_y,
      is_abs_y_3.b,
      is_abs_y_flags_2.b,
      is_abs_y_write_a_2.b,
    ),
    AND_ABS_Y.out.to(cmp_and_abs_y.b),
    cmp_and_abs_y.eq.to(
      outputs.is_and_abs_y,
      is_abs_y_4.b,
      is_abs_y_flags_3.b,
      is_abs_y_write_a_3.b,
    ),
    ORA_ABS_Y.out.to(cmp_ora_abs_y.b),
    cmp_ora_abs_y.eq.to(
      outputs.is_ora_abs_y,
      is_abs_y_5.b,
      is_abs_y_flags_4.b,
      is_abs_y_write_a_4.b,
    ),
    ...
    cmp_lda_ind_x.eq.to(
      outputs.is_lda_ind_x,
      is_ind_x_1.a,
      is_ind_x_flags_1.a,
      is_ind_x_write_a_1.a,
    ),
    ...
    cmp_adc_ind_x.eq.to(
      outputs.is_adc_ind_x,
      is_ind_x_2.b,
      is_ind_x_flags_1.b,
      is_ind_x_write_a_1.b,
    ),
    SBC_IND_X.out.to(cmp_sbc_ind_x.b),
    cmp_sbc_ind_x.eq.to(
      outputs.is_sbc_ind_x,
      is_ind_x_3.b,
      is_ind_x_flags_2.b,
      is_ind_x_write_a_2.b,
    ),
    AND_IND_X.out.to(cmp_and_ind_x.b),
    cmp_and_ind_x.eq.to(
      outputs.is_and_ind_x,
      is_ind_x_4.b,
      is_ind_x_flags_3.b,
      is_ind_x_write_a_3.b,
    ),
    ORA_IND_X.out.to(cmp_ora_ind_x.b),
    cmp_ora_ind_x.eq.to(
      outputs.is_ora_ind_x,
      is_ind_x_5.b,
      is_ind_x_flags_4.b,
      is_ind_x_write_a_4.b,
    ),
    ...
    is_ind_x_final.out.to(
      outputs.is_ind_x,
      done_ind_x.b,
      needs_operand_temp4.b,
      ptr_lo_load_ind_x.b,
      ptr_hi_load_ind_x.b,
      ind_x_sub3_signal.b,
      ind_x_sub4_signal.b,
    ...
    cmp_lda_ind_y.eq.to(
      outputs.is_lda_ind_y,
      is_ind_y_1.a,
      is_ind_y_flags_1.a,
      is_ind_y_write_a_1.a,
    ),
    ...
    cmp_adc_ind_y.eq.to(
      outputs.is_adc_ind_y,
      is_ind_y_2.b,
      is_ind_y_flags_1.b,
      is_ind_y_write_a_1.b,
    ),
    SBC_IND_Y.out.to(cmp_sbc_ind_y.b),
    cmp_sbc_ind_y.eq.to(
      outputs.is_sbc_ind_y,
      is_ind_y_3.b,
      is_ind_y_flags_2.b,
      is_ind_y_write_a_2.b,
    ),
    AND_IND_Y.out.to(cmp_and_ind_y.b),
    cmp_and_ind_y.eq.to(
      outputs.is_and_ind_y,
      is_ind_y_4.b,
      is_ind_y_flags_3.b,
      is_ind_y_write_a_3.b,
    ),
    ORA_IND_Y.out.to(cmp_ora_ind_y.b),
    cmp_ora_ind_y.eq.to(
      outputs.is_ora_ind_y,
      is_ind_y_5.b,
      is_ind_y_flags_4.b,
      is_ind_y_write_a_4.b,
    ),
    ...
    is_ind_y_final.out.to(
      outputs.is_ind_y,
      done_ind_y.b,
      needs_operand_temp5.b,
      ptr_lo_load_ind_y.b,
      ptr_hi_load_ind_y.b,
      ind_y_sub2_signal.b,
      ind_y_sub3_signal.b,
    ...
    cmp_jmp_ind.eq.to(
      ...
      needs_operand.b,
      needs_2nd_byte.b,
      jmp_ind_load_pc_signal.b,
      ptr_lo_load_jmp_ind.b,
      ptr_hi_load_jmp_ind.b,
      jmp_ind_sub2_signal.b,
      jmp_ind_sub3_signal.b,
    ),
    ...
    cmp_rti.eq.to(
      ...
      sp_inc_rti_sub2.b,
      sp_inc_rti_sub4.b,
      use_stack_rti_flags.b,
      use_stack_rti_lo.b,
      use_stack_rti_hi.b,
      rti_load_pc_signal.b,
      rti_pull_p_signal.b,
      update_flags_rti_signal.b,
      pull_pc_lo_rti.b,
      pull_pc_hi_rti.b,
    ),
    ...
    exec_sub1.out.to(
      ...
      done_branch.a,
      pc_inc_exec_sub1.a,
      addr_hi_load_signal.a,
      use_stack_rts_lo.a,
      use_stack_rti_flags.a,
      jmp_abs_load_pc_signal.a,
      rti_pull_p_signal.a,
      update_flags_rti_signal.a,
      pull_pc_lo_rts.a,
      branch_at_sub1.a,
      update_flags_lda.a,
      update_flags_cmp.a,
    ...
    exec_sub3.out.to(
      ...
      mem_read_abs_x.a,
      mem_read_abs_y.a,
      mem_write_abs_temp.a,
      mem_write_abs_x.a,
      mem_write_abs_y.a,
      mem_write_rmw.a,
      sp_dec_jsr_sub3.a,
      stack_write_jsr_lo.a,
      use_stack_rts_hi.a,
      use_stack_rti_lo.a,
      push_pc_lo_signal.a,
      pull_pc_lo_rti.a,
      pull_pc_hi_rts.a,
      update_flags_zp_xy.a,
      update_flags_rmw.a,
      ptr_lo_load_ind_x.a,
      ptr_hi_load_ind_y.a,
      ptr_hi_load_jmp_ind.a,
      ind_x_sub3_signal.a,
      ind_y_sub3_signal.a,
      jmp_ind_sub3_signal.a,
      write_a_zp.a,
      write_a_zp_x.a,
      write_x_ldx_zp_y.a,
    ),
    ...
    exec_sub4.out.to(
      ...
      done_jmp_ind.a,
      sp_inc_rti_sub4.a,
      jsr_load_pc_signal.a,
      rts_load_pc_signal.a,
      jmp_ind_load_pc_signal.a,
      update_flags_abs_y.a,
      ptr_hi_load_ind_x.a,
      ind_x_sub4_signal.a,
      ind_y_sub4_signal.a,
      write_a_abs_temp.a,
    ...
    exec_sub0.out.to(
      done_1cyc.a,
      pc_inc_exec_sub0.a,
      operand_load_signal.a,
      addr_lo_load_signal.a,
      sp_dec_pha.a,
      sp_dec_php.a,
      sp_inc_pla.a,
      sp_inc_plp.a,
    ...
    exec_sub2.out.to(
      ...
      mem_read_rmw.a,
      mem_write_zp.a,
      use_x_for_mem_signal.a,
      use_y_for_mem_signal.a,
      sp_dec_jsr_sub2.a,
      sp_inc_rts_sub2.a,
      sp_inc_rti_sub2.a,
      stack_write_jsr_hi.a,
      use_stack_pla.a,
      use_stack_plp.a,
      update_flags_plp_signal.a,
      push_pc_hi_signal.a,
      update_flags_bit_abs.a,
      ptr_lo_load_ind_y.a,
      ptr_lo_load_jmp_ind.a,
      ind_y_sub2_signal.a,
      jmp_ind_sub2_signal.a,
      write_a_pla.a,
    ),
    exec_sub5.out.to(
      done_rti.a,
      ...
      mem_write_ind_y.a,
      use_stack_rti_hi.a,
      rti_load_pc_signal.a,
      pull_pc_hi_rti.a,
      update_flags_ind_x.a,
      update_flags_ind_y.a,
      ind_x_sub5_signal.a,
      ind_y_sub5_signal.a,
      write_a_ind_x.a,
      write_a_ind_y.a,
    ...
    is_reset_hi_cmp.eq.to(
      next_from_reset_hi.sel,
      in_reset_state.b,
      outputs.is_reset_hi,
      outputs.reset_load_pc,
    ),
...
const CPU6502Core = circuit('CPU6502Core', {
  ...
  nodes: {
    ...
    pc_hi: Register(),
    always_on: Constant({ value: 1 }),
    pc_lo_inc: Incrementer,
    pc_lo_max: Comparator(),
    ff_const: Constant({ value: 255 }),
    pc_hi_inc: Incrementer,
    zero: Constant({ value: 0 }),
    one: Constant({ value: 1 }),
    two: Constant({ value: 2 }),
    three: Constant({ value: 3 }),
    four: Constant({ value: 4 }),
    five: Constant({ value: 5 }),
    six: Constant({ value: 6 }),
    seven: Constant({ value: 7 }),
    eight: Constant({ value: 8 }),
    nine: Constant({ value: 9 }),
    ten: Constant({ value: 10 }),
    eleven: Constant({ value: 11 }),
    twelve: Constant({ value: 12 }),
    thirteen: Constant({ value: 13 }),
    fourteen: Constant({ value: 14 }),
    fifteen: Constant({ value: 15 }),
    reset_vec_lo_addr: Constant({ value: 252 }),
    reset_vec_hi_addr: Constant({ value: 253 }),
    reset_vec_page: Constant({ value: 255 }),
    ir: Register(),
    operand_reg: Register(),
    addr_lo_reg: Register(),
    addr_hi_reg: Register(),
    pc_lo_temp: Register(),
    pc_hi_temp: Register(),
    flags: FlagRegister,
    addr_with_x: Adder(),
    addr_with_y: Adder(),
    ind_x_zp_addr: Adder(),
    ind_x_zp_addr_plus1: Incrementer,
    ptr_lo_reg: Register(),
    ptr_hi_reg: Register(),
    control: ControlFSM,
    ...
    sp: StackPointer,
    sp_load_or_reset: Or,
    sp_init: Constant({ value: 255 }),
    sp_load_value_mux: Mux(),
    pc_lo_minus_1: Subtractor(),
    one_const: Constant({ value: 1 }),
    pc_hi_minus_borrow: Subtractor(),
    const_one: Constant({ value: 1 }),
    status_byte: Combiner8to8,
    stack_data_pha_or_lo: Mux(),
    stack_data_with_php: Mux(),
    stack_data_final: Mux(),
    stack_bits: Splitter8to8,
    pc_lo_temp_we: Or,
    pc_hi_temp_we: Or,
    use_indexed_x_temp: Or,
    use_indexed_x_temp2: Or,
    use_indexed_x_temp3: Or,
    use_indexed_x: Or,
    effective_addr_x: Mux(),
    use_indexed_y: Or,
    effective_addr_y: Mux(),
    is_sta_abs_xy: Or,
    sta_abs_addr: Mux(),
    effective_addr_final: Mux(),
    ind_x_addr_sub4: Mux(),
    ind_x_addr_sub5: Mux(),
    use_ind_x_addr: Or,
    use_ind_x_addr_all: Or,
    operand_plus_1: Incrementer,
    ptr_with_y: Adder(),
    ind_y_addr_sub3: Mux(),
    ind_y_addr_sub5: Mux(),
    use_ind_y_addr: Or,
    use_ind_y_addr_all: Or,
    use_indirect_addr: Or,
    indirect_addr: Mux(),
    memory_addr_temp: Mux(),
    addr_lo_plus_1: Incrementer,
    jmp_ind_addr: Mux(),
    use_jmp_ind_addr: Or,
    memory_addr: Mux(),
    mem_data_x_mux: Mux(),
    ...
    inc_mem: Incrementer,
    dec_mem: Subtractor(),
    mem_bits: Splitter8to8,
    mem_shift_one: Constant({ value: 1 }),
    asl_mem_result: LeftShifter(),
    lsr_mem_result: RightShifter(),
    rol_mem_adder: Adder(),
    mem_c_times_128: Constant({ value: 128 }),
    ror_mem_add_val: Mux(),
    ror_mem_adder: Adder(),
    rmw_inc_or_dec: Mux(),
    rmw_or_asl: Mux(),
    ...
    rmw_or_rol: Mux(),
    rmw_result: Mux(),
    mem_data_rmw_mux: Mux(),
    inc_x: Incrementer,
    dec_x: Subtractor(),
    inc_y: Incrementer,
    dec_y: Subtractor(),
    rts_pc_lo_plus1: Incrementer,
    rts_pc_lo_max: Comparator(),
    rts_pc_hi_plus1: Incrementer,
    rts_pc_hi_final: Mux(),
    branch_adder_lo: Adder(),
    offset_sign: BitSlice({ low: 7, high: 7 }),
    sign_extend_ff: Constant({ value: 255 }),
    offset_hi: Mux(),
    branch_adder_hi: Adder(),
    is_zp_x_alu: Or,
    is_zp_x_alu_2: Or,
    is_zp_x_alu_3: Or,
    is_zp_x_alu_4: Or,
    ...
    eor_result: BusXor(),
    not_carry: Not,
    sbc_result: Subtractor(),
    adc_result: Adder(),
    operand_bits: Splitter8to8,
    adc_result_bits: Splitter8to8,
    sbc_result_bits: Splitter8to8,
    a_reg_bits: Splitter8to8,
    adc_a_xor_m: Xor,
    adc_same_sign: Not,
    adc_a_xor_result: Xor,
    v_adc: And,
    sbc_a_xor_result: Xor,
    v_sbc: And,
    a_bits: Splitter8to8,
    shift_one: Constant({ value: 1 }),
    asl_result: LeftShifter(),
    lsr_result: RightShifter(),
    rol_adder: Adder(),
    c_times_128: Constant({ value: 128 }),
    ror_add_val: Mux(),
    ror_adder: Adder(),
    is_and_any_temp: Or,
    is_and_any_temp2: Or,
    ...
    is_adc_any_temp3: Or,
    is_adc_any: Or,
    is_adc_or_sbc_any: Or,
    is_lda_zp_any: Or,
    result_a_lda_or_and: Mux(),
    result_a_or_ora: Mux(),
    result_a_or_eor: Mux(),
    result_a_or_sbc: Mux(),
    result_a_or_adc: Mux(),
    ...
    result_a_rol: Mux(),
    result_a: Mux(),
    result_x_tax_or_inx: Mux(),
    result_x_dex: Mux(),
    result_x_tsx: Mux(),
    result_x_ldx_imm: Mux(),
    result_x_ldx_zp_y: Mux(),
    result_x: Mux(),
    result_y_inc_dec: Mux(),
    result_y: Mux(),
    cmp_sub: Subtractor(),
    cpx_sub: Subtractor(),
    cpy_sub: Subtractor(),
    const_128: Constant({ value: 128 }),
    is_any_x_op_1: Or,
    is_any_x_op_2: Or,
    is_any_x_op_3: Or,
    is_any_x_op: Or,
    ...
    c_with_ror_zp: Mux(),
    c_from_sec: Mux(),
    const_true: Constant({ value: 1 }),
    c_value: Mux(),
    update_flags_from_stack: Or,
    update_n_signal: Or,
    update_z_signal: Or,
    update_c_temp: Or,
    update_c_signal: Or,
    ...
    new_i_value: Mux(),
    pc_lo_after_inc: Mux(),
    pc_lo_after_branch: Mux(),
    pc_lo_after_rts: Mux(),
    pc_lo_after_jsr: Mux(),
    pc_lo_after_jmp_abs: Mux(),
    pc_lo_after_jmp_ind: Mux(),
    pc_lo_after_rti: Mux(),
    pc_lo_after_reset: Mux(),
    pc_hi_should_inc: And,
    pc_hi_after_inc: Mux(),
    pc_hi_after_branch: Mux(),
    pc_hi_after_rts: Mux(),
    pc_hi_after_jsr: Mux(),
    pc_hi_after_jmp_abs: Mux(),
    pc_hi_after_jmp_ind: Mux(),
    pc_hi_after_rti: Mux(),
    pc_hi_after_reset: Mux(),
    stack_page: Constant({ value: 1 }),
    is_stack_op: Or,
    addr_lo_for_stack: Mux(),
    is_fetch_state: Comparator(),
    use_pc_for_addr_temp: Or,
    use_pc_for_addr: Or,
    normal_addr_lo: Mux(),
    addr_hi_for_stack: Mux(),
    normal_addr_hi: Mux(),
    in_reset_state: Or,
    reset_addr_lo: Mux(),
    final_addr_lo: Mux(),
  ...
  connect: ({
    ...
    inputs.data_in.to(
      ...
      dec_mem.a,
      mem_bits.in,
      asl_mem_result.value,
      lsr_mem_result.value,
      alu_b_operand.in1,
      result_a_imm_zp.in1,
      result_a_abs.in1,
      result_a_abs_x.in1,
      ...
      result_a_ind_y.in1,
      result_a_stack.in1,
      result_x_ldx_zp_y.in1,
      result_x.in1,
      pc_hi_after_jmp_abs.in1,
      pc_hi_after_reset.in1,
    ),
    addr_lo_reg.q.to(
      addr_with_x.a,
      addr_with_y.a,
      effective_addr_x.in0,
      addr_lo_plus_1.in,
      jmp_ind_addr.in0,
      pc_lo_after_jsr.in1,
      pc_lo_after_jmp_abs.in1,
    ),
    zero.out.to(
      addr_with_x.carry_in,
      addr_with_y.carry_in,
      ind_x_zp_addr.carry_in,
      pc_lo_minus_1.borrow_in,
      pc_hi_minus_borrow.b,
      ptr_with_y.carry_in,
      dec_mem.borrow_in,
      rol_mem_adder.b,
      ror_mem_add_val.in0,
      ror_mem_adder.carry_in,
      dec_x.borrow_in,
      dec_y.borrow_in,
      branch_adder_lo.carry_in,
      offset_hi.in0,
      rol_adder.b,
      ror_add_val.in0,
      ror_adder.carry_in,
    ...
    operand_reg.q.to(
      ...
      offset_sign.in,
      alu_b_operand.in0,
      result_a_lda_or_and.in0,
      result_x_ldx_imm.in1,
      result_y.in1,
      cpx_sub.b,
      cpy_sub.b,
      outputs.operand,
    ...
    update_flags_from_stack.out.to(
      update_n_signal.b,
      update_z_signal.b,
      update_c_signal.b,
      update_v_signal.b,
...
export const CPU6502CoreTest = circuit('CPU6502CoreTest', {
  nodes: {
    ...
    d_x: HexDisplay,
    d_y: HexDisplay,
    d_addr_lo: HexDisplay,
    d_addr_hi: HexDisplay,
    d_data_out: HexDisplay,
  },
  connect: ({
    nodes: { cpu, reset_input, data_input, d_pc, d_a, d_x, d_y, d_addr_lo, d_addr_hi, d_data_out },
  }) => [
...
export const CPU6502Test = circuit('CPU6502Test', {
  nodes: {
    rom: ROM({ baseAddress: 49152 }),
    system: System6502,
    reset_input: Input(),
    d_pc_lo: HexDisplay,
    d_pc_hi: HexDisplay,
    d_instruction: HexDisplay,
    d_a: HexDisplay,
    d_x: HexDisplay,
    d_y: HexDisplay,
    d_sp: HexDisplay,
