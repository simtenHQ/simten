    ...
    <section className="py-12">
      ...
      <div className="mt-8 prose-invert space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          general-purpose CPU interpreting instructions one by one, the &ldquo;program&rdquo; is the
          circuit topology itself. It can only play Pong, but it does so at one operation per clock
          cycle per gate.
        </p>
      </div>
    </section>
