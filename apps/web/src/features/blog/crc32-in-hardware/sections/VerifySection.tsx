    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <code className="text-sm bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded font-mono text-orange-400">
            0xCBF43926
          </code>
          . This is how you know your hardware matches the spec that governs every Ethernet chip in
          the world.
        </p>
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div className="rounded-lg bg-gray-900 border border-gray-700/50 overflow-hidden">
          ...
          <pre className="p-4 text-sm font-mono overflow-x-auto leading-relaxed">
            ...
            {'\n'}
            <span className="text-blue-400">import</span> CRC32{' '}
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          converts the signed 32-bit JavaScript integer to an unsigned value before converting to
          hex. CRC-32 is always an unsigned 32-bit number; JavaScript &rsquo;s bitwise operators
          work on signed 32-bit integers, so the coercion is necessary to print it correctly.
        </p>
