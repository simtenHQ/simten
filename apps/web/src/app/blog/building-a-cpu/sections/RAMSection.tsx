    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-300 leading-relaxed">
          ...
          <strong className="text-white">RAM</strong> &mdash; an array of
          memory cells, each with an address. You put an address on the bus and
          the data at that address appears on the output.
        </p>
        <p className="text-gray-300 leading-relaxed">
          The key insight:{" "}
          <strong className="text-white">reads are instant</strong>{" "}
          (combinational) but{" "}
          <strong className="text-white">writes need a clock tick</strong>.
