...
import { EmbedCanvas } from "@/components/circuit-embed";
      ...
      <div className="px-4 py-3 border-b border-gray-700/50">
        <div className="flex items-center gap-6 text-sm">
          <div>
            ...
            <div className="font-mono text-gray-300 mt-1 flex gap-4">
          ...
          {isDone && (
            <span className="ml-auto text-xs font-medium text-green-400 bg-green-900/30 px-2 py-1 rounded">
              Done &mdash; cos&thinsp;&asymp;&thinsp;{getDisplayValue("x")}, sin&thinsp;&asymp;&thinsp;{getDisplayValue("y")}
            </span>
          )}
        </div>
      </div>
