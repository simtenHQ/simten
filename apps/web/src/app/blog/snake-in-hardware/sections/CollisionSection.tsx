  ...
  return (
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-300 leading-relaxed">
          Two <strong className="text-white">Comparator</strong> nodes produce
          equality flags, and an{" "}
          <strong className="text-white">And</strong> gate combines them into a
          single <code className="text-blue-300">collision</code> signal. This
          feeds into a <strong className="text-white">Mux</strong> that outputs
