    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-300 leading-relaxed">
          ...
          Ethernet frame starts with a <strong className="text-white">preamble</strong>{" "}
          &mdash; a sequence of 0x55 bytes &mdash; followed by a{" "}
          <strong className="text-white">Start-of-Frame Delimiter</strong> (SFD,
          0xD5). The switch must detect this pattern to know when real data
          begins.
        </p>
        <p className="text-gray-300 leading-relaxed">
          This circuit implements a small{" "}
          <strong className="text-white">finite state machine</strong> with three
