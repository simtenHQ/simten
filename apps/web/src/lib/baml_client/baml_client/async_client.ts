...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async HardwareAgent(
        userMessage: string,dslCode: string,context: string,goalState: string,turnHistory: string,semanticSignals: string,
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.HardwareAgent(
          userMessage,dslCode,context,goalState,turnHistory,semanticSignals,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "HardwareAgent",
            {
            "userMessage": userMessage,"dslCode": dslCode,"context": context,"goalState": goalState,"turnHistory": turnHistory,"semanticSignals": semanticSignals
            },
        ...
        async HardwareAssistant(
        userMessage: string,dslCode: string,compactContext: string,conversationHistory: string[],
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.AssistantResponse> {
          try {
          const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
          const __signal__ = __options__.signal;
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.HardwareAssistant(
          userMessage,dslCode,compactContext,conversationHistory,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "HardwareAssistant",
            {
            "userMessage": userMessage,"dslCode": dslCode,"compactContext": compactContext,"conversationHistory": conversationHistory
            },
            this.ctxManager.cloneContext(),
            __options__.tb?.__tb(),
            __clientRegistry__,
            ...
            return __raw__.parsed(false) as types.AssistantResponse
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for HardwareAgent", error);
              }
              }
              };
              }
            ...
            userMessage: string,dslCode: string,compactContext: string,conversationHistory: string[],
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.AssistantResponse, types.AssistantResponse>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for HardwareAssistant", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.AssistantResponse, types.AssistantResponse>(
                  __raw__,
                  (a): partial_types.AssistantResponse => a,
                  (a): types.AssistantResponse => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
