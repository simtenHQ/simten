...
| `@simten/ui` | Canonical node components, shared canvas, ELK layout, sandbox context, `ClockControls`, and the [Monaco code editor](/docs/code-editor) (`@simten/ui/monaco`) |
| `@simten/embed` | `CircuitEmbed` convenience wrapper, `useCircuitSimulator` / `useCompiledCircuit` hooks |
