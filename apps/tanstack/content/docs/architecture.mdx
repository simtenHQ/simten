...
| `@simten/ui` | React components — canonical node renderers, shared canvas, ELK layout, `useCircuitSession` hook, `ClockControls`, editor UI. |
...
| `@simten/ui/canvas` | `CircuitCanvas`, `useCircuitSession`, `useSimulationSession`, `ClockControls` — shared simulation UI |
