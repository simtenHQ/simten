...
export const halfAdderDisplay = `const HalfAdder = component('HalfAdder', {
  in: { a: bit, b: bit },
  out: { sum: bit, carry: bit },
  nodes: { xor1: Xor, and1: And },
  connect: ({ in: inp, out, xor1, and1 }) => [
...
export const fullAdderDisplay = `const FullAdder = component('FullAdder', {
  in: { a: bit, b: bit, cin: bit },
  out: { sum: bit, cout: bit },
  nodes: { ha1: HalfAdder, ha2: HalfAdder, or1: Or },
  connect: ({ in: inp, out, ha1, ha2, or1 }) => [
...
export const counterDisplay = `const Counter = component('Counter', {
  out: { count: bus(8) },
  nodes: { reg: Register, adder: Adder, one: Constant },
  nodeArgs: { one: { value: 1 } },
  connect: ({ out, reg, adder, one }) => [
...
export const fibDisplay = `const Fibonacci = component('Fibonacci', {
  out: { fib: bus(8) },
  nodes: { reg_a: Register, reg_b: Register, adder: Adder, one: Constant, init: DFlipFlop },
  nodeArgs: { one: { value: 1 } },
  connect: ({ out, reg_a, reg_b, adder, one, init }) => [
