...
const MemoryBus = component('MemoryBus')
  .in('addr_lo', bus(8))
  .in('addr_hi', bus(8))
  .in('data_in', bus(8))
  .in('rw', bit)
...
const MemoryBusTest = component('MemoryBusTest')
  .node('rom', ROM, { baseAddress: 49152, data: {"49152":171,"65533":192} })
...
const ControlFSM = component('ControlFSM')
  .in('reset', bit)
  ...
  .node('JMP_ABS', Constant, { value: 76 })
...
const System6502 = component('System6502')
  .in('reset', bit)
  .in('rom_data', bus(8))
  .out('pc', bus(8))
  .out('pc_hi', bus(8))
...
const CPU6502Test = component('CPU6502Test')
  .node('rom', ROM, { baseAddress: 49152 })
