...
const RV32I_DualCPU = component('RV32I_DualCPU')
  ...
  .connect(({ in: inp, out, cpu0, cpu1 }) => [
    cpu0.net_tx_data.to(cpu1.net_rx_data),
    cpu0.net_tx_valid.to(cpu1.net_rx_valid),
    cpu0.net_tx_frame.to(cpu1.net_rx_frame),
    cpu1.net_tx_data.to(cpu0.net_rx_data),
    cpu1.net_tx_valid.to(cpu0.net_rx_valid),
    cpu1.net_tx_frame.to(cpu0.net_rx_frame),
    cpu0.pc_out.to(out.cpu0_pc),
    cpu1.pc_out.to(out.cpu1_pc),
  ])
  .build()
