...
function BreakoutDemoLoader() {
  return (
    <div className="rounded-xl border border-gray-700/50 bg-gray-900/50 p-8 flex items-center gap-3 text-gray-400">
  ...
  return (
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-300 leading-relaxed">
          Press <strong className="text-white">Run</strong> and use the arrow
