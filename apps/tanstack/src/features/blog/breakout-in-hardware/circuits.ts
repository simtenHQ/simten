 ...
 * Raster-scan architecture — no framebuffer RAM, like the original 1976 Atari hardware.
 */

export const BREAKOUT_DSL = `// Breakout — raster-scan architecture, no framebuffer RAM
//
