    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          takes just <strong className="text-gray-900 dark:text-white">4 clock cycles</strong>:
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          ...
          <strong className="text-gray-900 dark:text-white">comparators</strong>. The register
