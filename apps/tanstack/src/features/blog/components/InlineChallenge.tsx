...
export function InlineChallenge({
  ...
  return (
    <div className="my-8 rounded-xl border border-gray-700/50 bg-gray-900/30 overflow-hidden">
      {/* Header */}
      <div className="px-5 pt-4 pb-3 border-b border-gray-800/50">
        ...
        <p className="text-sm text-gray-400 mt-2 leading-relaxed">{objective}</p>
      </div>

      {/* Editor + Circuit side by side */}
      <div className="flex flex-col lg:flex-row">
        {/* Code editor */}
        <div className="lg:w-[45%] border-b lg:border-b-0 lg:border-r border-gray-800/50">
          <textarea
            ref={textareaRef}
            value={code}
            onChange={(e) => {
            ...
            spellCheck={false}
            className="w-full bg-transparent text-gray-300 font-mono text-[12px] leading-relaxed p-4 resize-none focus:outline-none"
      ...
      {/* Results + controls */}
      <div className="px-5 py-3 border-t border-gray-800/50 space-y-3">
        {/* Buttons */}
        <div className="flex items-center gap-3">
          <button
            onClick={handleCheck}
          ...
          <button
            onClick={handleReset}
            className="px-3 py-1.5 rounded-md text-sm text-gray-500 hover:text-gray-300 hover:bg-gray-800 transition-colors"
          >
            Reset
          </button>
