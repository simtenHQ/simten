  ...
  return (
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        ...
        <div className="rounded-lg bg-gray-900 border border-gray-800 p-4 font-mono text-sm text-gray-300">
        ...
        <p className="text-gray-300 leading-relaxed">
          The <code className="text-white bg-gray-800 px-1.5 py-0.5 rounded text-sm">sub</code> needs
          the result of <code className="text-white bg-gray-800 px-1.5 py-0.5 rounded text-sm">add</code>,
          but in a pipeline, <code className="text-white bg-gray-800 px-1.5 py-0.5 rounded text-sm">sub</code> enters
          the Decode stage while <code className="text-white bg-gray-800 px-1.5 py-0.5 rounded text-sm">add</code> is
          still in Execute. The result hasn&rsquo;t been written back to the
          register file yet.
        </p>

        <p className="text-gray-300 leading-relaxed">
          This is a <strong className="text-white">data hazard</strong>. There
          are two solutions:
        </p>
        ...
        <div className="space-y-4">
          <div className="rounded-lg border border-gray-800 p-4">
            ...
            <p className="text-sm text-gray-400">
              ...
              <strong className="text-gray-300">load-use</strong> hazards &mdash;
          ...
          <div className="rounded-lg border border-gray-800 p-4">
            ...
            <p className="text-sm text-gray-400">
              ...
              through a <strong className="text-gray-300">forwarding mux</strong>.
        ...
        <p className="text-gray-300 leading-relaxed">
          <strong className="text-white">Control hazards</strong> are the other
