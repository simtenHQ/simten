    ...
    <section className="py-12">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-gray-800 p-5">
          ...
          <pre className="mt-3 rounded-lg bg-gray-900 border border-gray-800 p-3 font-mono text-xs text-gray-300">
{`int x = 5;
int y = x + 3; // needs x immediately`}
        ...
        <div className="rounded-xl border border-gray-800 p-5">
          ...
          <p className="text-sm text-gray-400 leading-relaxed">
            Add an <code className="text-white bg-gray-800 px-1 py-0.5 rounded text-xs">if</code> statement.
