...
export function CTASection() {
  return (
    <section className="py-16">
      <div className="rounded-2xl border border-gray-800 bg-gradient-to-b from-gray-900 to-gray-950 p-8 md:p-12 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            to="/editor"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-gray-800 hover:bg-gray-700 text-gray-200 font-medium transition-colors border border-gray-700"
          >
            Build from scratch
          </Link>
        </div>
