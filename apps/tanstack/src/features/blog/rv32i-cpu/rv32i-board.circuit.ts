...
export const RV32I_Board = circuit('RV32I_Board', {
  nodes: { cpu: RV32I_Core, rom: DualPortROM, mem_bus: MemBusMux, dmem: RV32I_DataMem, uart: UART_TX, imem_load_align: RV32I_LoadAlign, zero32: Constant, zero1: Constant, pc_display: HexDisplay },
