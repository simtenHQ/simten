  ...
  return (
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        ...
        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
          A <strong className="text-gray-900 dark:text-white">phase counter</strong> is just a
          2-bit register that increments each tick: 0 &rarr; 1 &rarr; 2 &rarr;
          3 &rarr; 0. We use{" "}
          <strong className="text-gray-900 dark:text-white">BitSlice(low=0, high=1)</strong> to
