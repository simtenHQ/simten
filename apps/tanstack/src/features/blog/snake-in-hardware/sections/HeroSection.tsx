...
export function HeroSection() {
  return (
    <section className="py-8 md:py-12">
      <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-white leading-tight mb-2">
        Snake in Hardware
      </h1>
      ...
      <ClientOnly>
        <Suspense
          fallback={
            <div className="rounded-xl border border-gray-700/50 bg-gray-900/50 p-8 mb-8" style={{ minHeight: 400 }}>
