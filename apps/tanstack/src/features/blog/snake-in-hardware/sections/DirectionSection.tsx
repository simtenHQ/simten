    ...
    <section className="py-12">
      ...
      <div className="prose-invert space-y-6">
        <p className="text-gray-300 leading-relaxed">
          ...
          <strong className="text-white">deltaX</strong> and{" "}
          <strong className="text-white">deltaY</strong>, each either
          &minus;1,&nbsp;0, or&nbsp;+1.
        </p>
        <p className="text-gray-300 leading-relaxed">
          Four <strong className="text-white">Comparator</strong> nodes check
          the key code against each direction constant. The results feed into a{" "}
          <strong className="text-white">Mux tree</strong> &mdash; a cascade of
