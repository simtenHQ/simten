          ...
          <div className="px-4 py-3 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] rounded bg-muted text-muted-foreground border border-border px-1.5 py-0.5">
                {CATEGORY_LABELS[selected.circuit.metadata?.category ?? ""] ?? selected.circuit.metadata?.category}
              </span>
            </div>
            <p className="text-sm text-muted-foreground mt-1">{selected.circuit.metadata?.description}</p>
          </div>
